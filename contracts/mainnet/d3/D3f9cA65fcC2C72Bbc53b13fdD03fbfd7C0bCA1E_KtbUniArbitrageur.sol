...
contract KtbUniArbitrageur is ReentrancyGuard {
    ...
    function arbitrage(
        ...
        // KUA_CAC: caller is a contract
        require(tx.origin == msgSender, "KUA_CAC");
        ...
        emit Arbitrage(kantabanVault, tokenIn, tokenOut, amountIn, isToBuyOnKtb, uniswapV3PoolFeeTier, profit);
