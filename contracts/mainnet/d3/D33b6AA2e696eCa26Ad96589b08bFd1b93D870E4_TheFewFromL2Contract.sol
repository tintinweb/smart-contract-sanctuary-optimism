...
//  /_  __/ /_  ___     / ____/__ _      __   / ____/________  ____ ___     / /  |__ \
//   / / / __ \/ _ \   / /_  / _ \ | /| / /  / /_  / ___/ __ \/ __ `__ \   / /   __/ /
//  / / / / / /  __/  / __/ /  __/ |/ |/ /  / __/ / /  / /_/ / / / / / /  / /___/ __/ 
// /_/ /_/ /_/\___/  /_/    \___/|__/|__/  /_/   /_/   \____/_/ /_/ /_/  /_____/____/ 
//                                                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1675224000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1675213200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x78ED254b9c140c1A2BE10d2ad32C65b5f712f54b];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 939;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiblapomyvkkjmw6bhkbb77y4i2n6synd375ugzhq6y2o27upvxlmm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5LWbXgxM4NMYB5U3ROLe/contract-metadata";
  }
...
// File: contracts/TheFewFromL2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheFewFromL2Contract is RamppERC721A {
    constructor() RamppERC721A("The Few From L2", "FEWL2"){}
}