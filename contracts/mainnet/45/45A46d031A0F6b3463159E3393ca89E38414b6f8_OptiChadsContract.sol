/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-08-01
*/
...
// __  __ \_________  /___(_)_  ____/__  /_______ ______  /_______
// _  / / /__  __ \  __/_  /_  /    __  __ \  __ `/  __  /__  ___/
// / /_/ /__  /_/ / /_ _  / / /___  _  / / / /_/ // /_/ / _(__  ) 
// \____/ _  .___/\__/ /_/  \____/  /_/ /_/\__,_/ \__,_/  /____/  
//        /_/                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x10850762bAc0dc6660630c1EfFe188A7cbFDdc88,0x4D014f3c5F33Aa9Cd1Dc29ce29618d07Ae666d15];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmf6jpLyZyLxioDF3Str1msh6uqxvJRXMrp75jMvmxoDnh/";
...
// File: contracts/OptiChadsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptiChadsContract is RamppERC721A {
    constructor() RamppERC721A("OptiChads", "CHAD"){}
}