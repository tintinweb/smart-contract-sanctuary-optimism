...
/**
 @title The most trusted crypto airdrop bulksending tool, supports Optimism, Ethereum, Ether, Erc20 token, BSC, BNB, BEP20 tokens, HT, HRC20 tokens, MATIC (Polygon),  Arbitrumx One, OKEx Chain, Avalanche AVAX, Famtom FTM, xDai, XinFin Network, Harmony, Evmos, Solana, TRX, trc20 tokens, trc10 tokens and NFTs
