...
contract VeArtProxy is IVeArtProxy {
    ...
    string[5][10] palettes =
        [['#E0A100','#CC9200','#A37500','#3C4150','#A3A3A3'], // yellow-gold
        ['#D40D0D','#A10808','#750606','#3C4150','#A3A3A3'], //red
        ['#03444C','#005F6B','#008C9E','#3C4150','#A3A3A3'], //teal
        ['#1A50F1','#1740BB','#102F8B','#3C4150','#A3A3A3'], //blue
        ['#C5BC8E','#696758','#45484b','#3C4150','#A3A3A3'], //silver
        ['#FD5821','#F23E02','#CA3402','#3C4150','#A3A3A3'], //amber
        ['#b48610','#123291','#cf3502','#3C4150','#A3A3A3'], //velodrome
        ['#719E04','#8DB92E','#A9D54C','#3C4150','#A3A3A3'], //green
        ['#110E07','#110E07','#3A3935','#3C4150','#A3A3A3'], //black
        ['#CC1455','#A71145','#820D36','#3C4150','#A3A3A3']]; //pink

    uint8[5] lineThickness = [0, 1, 1, 2, 2];
    ...
    function tokenURI (uint256 _tokenId) external view returns (string memory output) {
        ...
        string memory attributes = string(
            abi.encodePacked(
	            '{',
                    '"display_type": "date",',
                    '"trait_type": "Unlock Timestamp",',
                    '"value": ', toString(cfg._lockedEnd),
	            '},',
                '{',
                    '"trait_type": "Unlock Date",',
                    '"value": "', toString(year), '-', toString(month), '-', toString(day), '"',
                '},'
            )
        );
                ...
                string(
                    abi.encodePacked(
			            '{',
                            ...
                            '"description": "Velodrome Finance is a next-generation AMM that combines the best of Curve, Convex and Uniswap, designed to serve as the Optimism central liquidity hub. Velodrome NFTs vote on token emissions and receive bribes and fees generated by the protocol.",',
