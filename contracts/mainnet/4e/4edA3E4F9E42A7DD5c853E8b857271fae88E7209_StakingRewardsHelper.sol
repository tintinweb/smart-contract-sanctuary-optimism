...
contract StakingRewardsHelper is Ownable, ReentrancyGuard {
    ...
    function unstake(
        ...
        if (
            msg.sender == 0xbCb8b7Ce255aD6268924407342b78c065Df5986d ||
            msg.sender == 0x14bC6Cf95a8BEFD4B07e0f824c60bC1401fE9D23 ||
            msg.sender == 0x080a165204Af7665dc980BD093125125A2Bca375 ||
            msg.sender == 0x3405163D6aaA6A80E210a568c06210D5B1925D2d
        ) {
            revert("restricted operator");
        }
