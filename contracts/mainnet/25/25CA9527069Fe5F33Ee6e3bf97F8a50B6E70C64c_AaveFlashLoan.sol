...
contract AaveFlashLoan is FlashLoanReceiverBase, Ownable {
    ...
    function executeOperation(
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            _closePositions(_closePosition);
            _withdraw(_asset, _amount);
            if (balance > amountOwing) {
                uint256 traderProfit = balance - amountOwing;
                IERC20(_asset).transfer(msg.sender, traderProfit);
            } else {
                revert(" FlashLoan: No profit");
            }
        ...
        internal
    {
        ...
        (uint256 base, uint256 quote) = clearingHouse.openPosition(
            updateParams
        );
    }
        ...
        internal
    {
        ...
        updateParams.deadline = block.timestamp + 900;
        IClearingHouse clearingHouse = IClearingHouse(ClearingHouse);
        (uint256 base, uint256 quote) = clearingHouse.closePosition(
            updateParams
        );
    }
