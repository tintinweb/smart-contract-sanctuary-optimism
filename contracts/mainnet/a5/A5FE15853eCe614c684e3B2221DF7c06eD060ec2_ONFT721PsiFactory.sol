...
import "../onft/ONFT721Psi.sol";

contract ONFT721PsiFactory {
    ...
    function create(
        ...
        ONFT721Psi onft = new ONFT721Psi(_name, _symbol, _collectionURI, _tokensURI, msg.sender, minGasToTransfer, lzEndpoint);
    ...
    function setMinGasToTransfer(uint256 _minGasToTransfer) external {
        require(msg.sender == _owner);
        require(_minGasToTransfer > 0, "ONFT721PsiFactory: !minGasToTransfer");
        minGasToTransfer = _minGasToTransfer;
    }
}
...
contract ONFT721Psi is ONFT721Core, ERC721Psi {
    ...
    function _debitFrom(address _from, uint16, bytes memory, uint _tokenId) internal virtual override {
        require(_isApprovedOrOwner(msg.sender, _tokenId), "ONFT721Psi: send caller is not owner nor approved");
        require(ERC721Psi.ownerOf(_tokenId) == _from, "ONFT721Psi: send from incorrect owner");
    ...
    function setTrustedRemoteAndLimits(
        ...
        require(_dstChainIdToTransferGas > 0, "ONFT721Psi: dstChainIdToTransferGas must be > 0");
        dstChainIdToTransferGas[_remoteChainId] = _dstChainIdToTransferGas;
        require(_dstChainIdToBatchLimit > 0, "ONFT721Psi: dstChainIdToBatchLimit must be > 0");
