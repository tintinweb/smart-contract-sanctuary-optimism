...
// File src/interfaces/solidly.sol
// License-Identifier: MIT
pragma solidity ^0.6.2;
...
interface ICurveChildChainGaugeRewardHelper {
  function claimRewards(address gauge, address user) external;

  function pendingRewards(address gauge, address user, address token) external view returns(uint256);
}
...
// File src/strategies/optimism/velodrome/strategy-velo-base.sol
// License-Identifier: MIT
pragma solidity ^0.6.7;
...
// File src/strategies/optimism/velodrome/strategy-velo-op-l2dao-vlp.sol
// License-Identifier: MIT
pragma solidity ^0.6.7;
...
contract StrategyVeloOpL2daoVlp is StrategyVeloBase {
        ...
        )
    {
        ...
        // token1 route
        nativeToTokenRoutes[l2dao].push(RouteParams(native, op, false));
        nativeToTokenRoutes[l2dao].push(RouteParams(op, l2dao, false));
    }
