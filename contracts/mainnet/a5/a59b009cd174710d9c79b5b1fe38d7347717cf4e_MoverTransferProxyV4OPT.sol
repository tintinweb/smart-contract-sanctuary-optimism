...
*/
contract MoverTransferProxyV4OPT is AccessControlUpgradeable, SafeAllowanceResetUpgradeable, ITransferProxyV2 {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    function bridgeAssetDirect(address _token, uint256 _amount, bytes memory _bridgeTxData, address _relayTarget) internal {
        ...
        require(targetAddress == 0x470f9522ff620eE45DF86C58E54E6A645fE3b4A7, "unknown bridge");
