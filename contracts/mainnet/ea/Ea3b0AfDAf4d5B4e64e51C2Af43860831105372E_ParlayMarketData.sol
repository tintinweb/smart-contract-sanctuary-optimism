            ...
            if (ISportPositionalMarket(_sportMarket[i]).resolved() && !ISportPositionalMarket(_sportMarket[i]).cancelled()) {
                ...
                for (uint j = 0; j < max_length; j++) {
                    if (homeParlays.length > j) {
                        ...
                        addToExercise = (!alreadyLost && marketResult != 1) || (alreadyLost && marketResult == 1 && !addToExercise);
                        if (addToExercise) {
                    ...
                    if (awayParlays.length > j) {
                        ...
                        addToExercise = (!alreadyLost && marketResult != 2) || (alreadyLost && marketResult == 2 && !addToExercise);
                        if (addToExercise) {
                    ...
                    if (drawParlays.length > j) {
                        ...
                        addToExercise = (!alreadyLost && marketResult != 3) || (alreadyLost && marketResult == 3 && !addToExercise);
                        if (addToExercise) {
