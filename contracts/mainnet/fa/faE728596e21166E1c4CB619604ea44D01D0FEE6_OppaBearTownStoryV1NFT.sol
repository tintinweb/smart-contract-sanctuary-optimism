...
contract OppaBearTownStoryV1NFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard {
  ...
  uint256 public TEAM_NFT_COUNT = 20;
  ...
  constructor() ERC721A("Oppa Bear Town Story V.1", "OPPABEARTOWNSTORYV1") {
  }
