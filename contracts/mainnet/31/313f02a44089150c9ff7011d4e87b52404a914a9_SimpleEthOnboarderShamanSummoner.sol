...
// File: @daohaus/baal-contracts/contracts/interfaces/IBaal.sol
...
// File: contracts/shaman/SimpleEthOnboarder.sol
...
contract SimpleEthOnboarderShamanSummoner {
    ...
    function summonOnboarder(
        ...
        SimpleEthOnboarderShaman onboarder = SimpleEthOnboarderShaman(payable(Clones.clone(template)));
