/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-08-15
*/
...
// File: contracts/BIFI/strategies/Common/StrategyCommonChefSolidlyLP.sol
...
contract StrategyCommonChefSolidlyLP is StratFeeManager, GasFeeThrottler {
    ...
    function addLiquidity() internal {
        ...
        if (stable) {
            uint out0 = ISolidlyRouter(unirouter).getAmountsOut(lp0Amt, outputToLp0Route)[outputToLp0Route.length];
            uint out1 = ISolidlyRouter(unirouter).getAmountsOut(lp1Amt, outputToLp1Route)[outputToLp1Route.length];
