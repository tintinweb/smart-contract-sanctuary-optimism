...
contract Trending is ERC721 {
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        return string.concat(
            ...
            Base64.encode(
                abi.encodePacked(
                    '{ "name": "!FUN", "description": "an experiment", "image": "' "data:image/svg+xml;base64,",
                    Base64.encode(
                        bytes(
                            '<svg width="500" height="500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="background-color:black"> <text fill="white" x="2.5" y="12" font-size="1">if you\'re reading this we\'re trending on mint.fun</text></svg>'
                        )
                    ),
                    '"}'
                )
