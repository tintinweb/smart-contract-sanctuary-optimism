/**
 *Submitted for verification at optimistic.etherscan.io on 2022-01-19
*/
...
// File src/strategies/optimism/strategy-base.sol
...
// File src/interfaces/zip-chef.sol
...
// File src/strategies/optimism/strategy-zip-farm-base.sol
...
abstract contract StrategyZipFarmBase is StrategyBase {
    ...
    function _withdrawSome(uint256 _amount)
        ...
        returns (uint256)
    {
        IZipChef(zipChef).withdraw(poolId, _amount, address(this));
        return _amount;
    }
...
// File src/strategies/optimism/zipswap/strategy-zip-eth-usdc-lp.sol
