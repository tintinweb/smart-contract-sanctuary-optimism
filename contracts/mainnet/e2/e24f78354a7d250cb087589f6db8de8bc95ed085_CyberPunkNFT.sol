...
// File: contracts/prod/artifacts/CyberPunk.sol
...
contract CyberPunkNFT is ERC721A, Ownable {
    ...
    constructor() ERC721A("CyberPunk", "CP-NFT") {
    ...
    function airdropCyberPunk(address mintAddress,uint8 numberTokens)external onlyOwner{
