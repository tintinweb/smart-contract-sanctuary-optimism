...
contract Staking is Ownable {
  ...
  uint256 public immutable ONE_RING_PER_SECOND;
  ...
  constructor() {
    uint256 oneRingPerDay = 2000 ether; /// 60_000 - month | 180_000 - 3 months
    ONE_RING_PER_SECOND = oneRingPerDay / 86400;
  }
  ...
  function getNewAccumulator() internal view returns (uint256) {
    if (totalStaked == 0) {
      ...
      uint256 numerator = ONE_RING_PER_SECOND * (block.timestamp - lastUpdate) * 1e24;
