...
//
//
//            ____        __________  ________  _______   _______________
//   / __ \      / ____/ __ \/ ____/\ \/ /__  /  /  _/ ____/ ___/
//  / / / /_____/ /   / /_/ / __/    \  /  / /   / // __/  \__ \ 
// / /_/ /_____/ /___/ _, _/ /___    / /  / /___/ // /___ ___/ / 
// \____/      \____/_/ |_/_____/   /_/  /____/___/_____//____/  
//                                                               
//     
//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 9909 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmf7yEGcJw3FR7f5canKUuw1JsdQZZXMNDCMyUvVy6EeZm/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9909");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9909");
...
// File: contracts/X0CreyziesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X0CreyziesContract is RamppERC721A {
    constructor() RamppERC721A("0CREYZIES", "CREYZIES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vMCq6RHEQJB3VlsuWgxE/contract-metadata";
    }
}
