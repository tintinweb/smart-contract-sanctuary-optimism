...
contract ApetimismLaunchpadNFT is ERC721AQueryable, Ownable, ReentrancyGuard /*, ERC2981*/ {
  ...
  uint256 public MAX_SUPPLY = 1150;
  uint256 public START_TOKEN_ID = 1;
  string private constant TOKEN_NAME = "1st Impact";
  string private constant TOKEN_SYMBOL = "1STIMPACT";
  ...
  address public signerAddress = 0x30be7bceecfffa0EE3c3653Cb386D4177752682B;

  uint8 public currentRound = 0;
  bool public metadataFrozen = false;
  uint16 public maxMintPerTx = 5;
  uint16 public maxMintPerAddress = 25;
