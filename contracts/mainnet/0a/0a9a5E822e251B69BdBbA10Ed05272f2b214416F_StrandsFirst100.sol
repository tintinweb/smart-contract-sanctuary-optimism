...
/**
 * TODO:  Use `onlyAdmin`, instead of  `onlyOwner`, modifier
 */
contract StrandsFirst100 is ERC721, OwnableAdmins {
    ...
    address private bobsBurgers = 0x3960b0Eac90Aae9FeE27D0AeDBb81d951B72862A;
    ...
    constructor(string memory _baseURI) ERC721("StrandsFirst100", "F100") {
        baseURI = _baseURI;
        _addAdmin(msg.sender);
    }
    ...
    function transferFrom(
        ...
        ERC20(USDC_ADDRESS).transferFrom(from, bobsBurgers, amount);
