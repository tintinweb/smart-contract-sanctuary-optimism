...
contract PINT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"UnircornPiss";
    string private constant _symbol = unicode"TRISSPINT";
    ...
    function openTrading() external onlyOwner() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF9678db1CE83f6f51E5df348E2Cc842Ca51EfEc1);
