/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-07-25
*/
...
contract ERC20Token is IERC20 {
    ...
    constructor() {
        ...
        // Set IPFS logo URI
        _logoURI = "ipfs://Qmf8dpMHswzKtBMFvoQgtzqtVN4vVuNWf7LsmA4SurT4Wd";
    }
    ...
    function updateLogoURI(string memory newURI) public {
        require(msg.sender == _deployerWallet, "Only the deployer can update logo URI");
        _logoURI = newURI;
    }
}