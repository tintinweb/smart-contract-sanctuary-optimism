    ...
    function adjustPosition(bool operationType, bool positionType, uint256 amount) public override onlyTrigger() {
        ...
        if (operationType) {// openPosition
            ...
            if (positionType) {
                ...
                uint256 ethAmount = _buyTokensToUniswap(_usdToken, _wToken, usdcAmount);
                ...
                if (IERC20(_wToken).balanceOf(address(this)) < ethAmount || perpPosition < ethAmount) {
                    ...
                    _buyTokensToUniswap(_wToken, _usdToken, ethAmount);
   ...
   * @dev returns user profit in USDC  (1e6)
    ...
    * @notice Total deposit amount
    ...
    function _fullClose() private {
        ...
        emit PositionAdjusted(false, false, IERC20(_usdToken).balanceOf(address(this)), 0, getTotalUSDCValue());
    }
...
abstract contract StrategyStorage is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function _buyTokensToUniswap(address _tokenA, address _tokenB, uint256 amount) internal returns(uint256){
