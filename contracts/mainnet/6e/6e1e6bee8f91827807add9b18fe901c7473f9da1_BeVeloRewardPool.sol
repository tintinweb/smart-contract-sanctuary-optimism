...
// File: contracts/BIFI/strategies/BeSolid/BeVeloRewardPool.sol

pragma solidity ^0.8.0;
contract BeVeloRewardPool is Ownable {
    ...
    constructor(address _token, address _notifier, uint256 _duration) {
        token = IERC20(_token);
        notifier = _notifier;
        duration = _duration;
    }
    ...
    modifier onlyWhitelist(address account) {
        require(whitelist[account] == true, "!whitelist");
        _;
    }
    ...
    function rewardPerToken() public view returns (uint256) {
        ...
        uint256 rewardRateTimesOne = rewardRate * 1e18;
        
        uint256 equation = time * rewardRateTimesOne / totalSupply();
    ...
    function addWhitelist(address _strategy) external onlyManager {
    ...
    // Sets notifier
    function setNotifier(address newNotifier) external onlyManager {
        ...
        updateReward(address(0))
    {
        ...
        require(reward <= balance - userRewards, "!too many rewards");
