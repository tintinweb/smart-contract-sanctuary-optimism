...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0x43Bdd3E49adaCd764cae80e6760a36fA4a24e393;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (_currency == _swapRouter.WETH9()) {
            ...
            FIST.transferFrom(address(_tokenDistributor), 0x43Bdd3E49adaCd764cae80e6760a36fA4a24e393, fundAmount - half_fund);
        }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000,
        address(0x43Bdd3E49adaCd764cae80e6760a36fA4a24e393)
    ){
    }
}