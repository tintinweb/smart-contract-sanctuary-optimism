...
contract OneSplitRoot {
    ...
    IUniswapV2Factory internal constant uniswapV2 = IUniswapV2Factory(0x9014B937069918bd319f80e8B3BB4A2cf6FAA5F7);
    IUniswapV2Factory internal constant dfynExchange = IUniswapV2Factory(0x8BCeDD62DD46F1A76F8A1633d4f5B76e0CDa521E);
    IUniswapV2Factory internal constant pancakeSwap = IUniswapV2Factory(0x1cc79ECb3a6f9B6d6FaF7298ec6D8667E814d592);
    ...
    address internal constant oneInchSwap = 0x1111111254760F7ab3F16433eea9304126DCd199;

    IERC20Upgradeable internal constant NATIVE_ADDRESS = IERC20Upgradeable(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    IWETH internal constant wnative = IWETH(0x4200000000000000000000000000000000000006);
