...
contract MatrixLpAutoCompound is MatrixStrategyBase, MatrixSwapHelper {
    ...
    function _initialize(address _masterchef, address _output, uint256 _poolId) internal virtual {
        ...
        returns (uint256 _wantHarvested)
    {
        ...
        uint256 _lp0Balance = IERC20(lpToken0).balanceOf(address(this));
        uint256 _lp1Balance = IERC20(lpToken1).balanceOf(address(this));
