...
contract HausBurst is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("HausBurst", "DHB") {}
    ...
    {
        string memory _nftName = string(abi.encodePacked("HausBurst"));
        string memory _animation = string(abi.encodePacked(
            "https://ipfs.io/ipfs/bafybeicl5nzcl66rq5gsatihytisryvmgtv6lvwrtbbmwey43ue3qoevk4/dao.html?seed=",
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "description": "DAOhaus - The north star rises"}'
                            )
                        )
                    )
                )
