/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-11-27
*/
...
contract QuixoticLaunchpadERC721 is ERC721("Just Meow", "Meowww"), ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens + addressToNumberMinted[_msgSender()] <= 200, "Exceeded max token purchase");
