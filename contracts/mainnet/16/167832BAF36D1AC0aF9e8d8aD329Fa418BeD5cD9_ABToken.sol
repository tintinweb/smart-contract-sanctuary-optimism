 ...
 * @notice Anotherblock Soulbound Token Contract on Optimism
 **/
...
contract ABToken is SuperSoulbound, AccessControl {
     ...
     */
    constructor(address _host, address _admin) SuperSoulbound(_host, _admin) {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER, msg.sender);
    }

    //     ____        __         ____        __
    //    / __ \____  / /_  __   / __ \____  / /__  _____
    //   / / / / __ \/ / / / /  / /_/ / __ \/ / _ \/ ___/
    //  / /_/ / / / / / /_/ /  / _, _/ /_/ / /  __(__  )
    //  \____/_/ /_/_/\__, /  /_/ |_|\____/_/\___/____/
    //               /____/
    ...
    /**
     * @notice
     *  Mint `_amount` of AB Tokens to `_receiver` address
     *
     *  Only caller with MINTER role can call this function
     *
    ...
    /**
     * @notice
     *  Burn `_amount` of AB Tokens from `_from` address
     *
     *  Only caller with BURNER role can call this function
     *
     * @param _from address to burn the token from
     * @param _amount amount to be burnt
     */
    function spend(address _from, uint256 _amount) external onlyRole(BURNER) {
...
/**
 * @title SuperfluidSoulbound
 * @author Anotherblock Technical Team
 * @notice Superfluid Token Soulbound version developed by anotherblock.io
 **/
