...
contract OWDistributionPool is Initializable, OwnableUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;
    using SignatureChecker for EnumerableSet.AddressSet;
    using ECDSA for bytes32;               

    uint256 public constant MAX_ADDRESSES = 3000000;
    ...
    function setSigner(address val) public onlyOwner() {
        require(val != address(0), "OW: val is the zero address");
        signer = val;
    }
