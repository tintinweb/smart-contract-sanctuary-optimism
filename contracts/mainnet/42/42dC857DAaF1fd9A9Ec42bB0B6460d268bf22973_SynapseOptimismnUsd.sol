...
contract SynapseOptimismnUsd is Defii, DefiiWithCustomExit {
    IERC20 constant USDC = IERC20(0x7F5c764cBc14f9669B88837ca1490cCa17c31607);

    IERC20 constant nUSDLP = IERC20(0x2c6d91accC5Aa38c84653F28A80AEC69325BDd12);
    IERC20 constant SYN = IERC20(0x5A5fFf6F753d7C11A56A52FE47a177a87e431655);

    ISwapFlashLoan constant swapFlashLoan =
        ISwapFlashLoan(0xF44938b0125A6662f9536281aD2CD6c499F22004);
    IMiniChefV2 constant miniChef =
        IMiniChefV2(0xe8c610fcb63A4974F02Da52f0B4523937012Aaa0);
    ...
    function exitParams(uint256 slippage) public view returns (bytes memory) {
        ...
        return abi.encode(1, ((usdcPerLp * slippage) / 1000));
    }
