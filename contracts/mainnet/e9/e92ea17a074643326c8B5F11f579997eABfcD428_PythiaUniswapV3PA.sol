...
contract PythiaVersioning {
    string public constant PYTHIA_CORE_VERSION = "v1.0.0-rc.11";
    string public constant PYTHIA_PERIPHERY_VERSION = "v1.0.0-rc.8";
    string public constant PYTHIA_PROTOCOL_VERSION = "v0.0.7";
}
