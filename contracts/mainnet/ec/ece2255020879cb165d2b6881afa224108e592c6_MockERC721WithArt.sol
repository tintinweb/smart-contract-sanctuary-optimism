...
contract MockERC721WithArt is ERC721URIStorage, Ownable {
    address public artProxy;

    constructor(string memory name_, string memory symbol_, address _artProxy) ERC721(name_, symbol_) {
        artProxy = _artProxy;
    }

    function mint(address to, uint256 tokenId) public {
        require(tokenId < 1002);
        _mint(to, tokenId);
    }
    ...
    function setTokenURI(address _artProxy) external onlyOwner {
        artProxy = _artProxy;
