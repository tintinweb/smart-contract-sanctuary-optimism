...
/*                                             _             _          
 *                                            (_)           | |         
 *   ___ _ __   __ _  ___ ___  ___  __ _ _   _ _  __ _  __ _| | ___ ____
 *  / __| '_ \ / _` |/ __/ _ \/ __|/ _` | | | | |/ _` |/ _` | |/ _ \_  /
 *  \__ \ |_) | (_| | (_|  __/\__ \ (_| | |_| | | (_| | (_| | |  __// / 
 *  |___/ .__/ \__,_|\___\___||___/\__, |\__,_|_|\__, |\__, |_|\___/___|
 *      | |                           | |         __/ | __/ |           
 *      |_|                           |_|        |___/ |___/             
 *
 *
 *  Welcome to spacesquigglez, young traveler!
 *  
 *  This is a collection of 777 randomly generated, randomly named, randomly colored, squiggly, spacey NFT's.
 *  No IPFS BS, No risk of losing access to your tokens. Just pure Solidity code that is calculated and stored
 *  100% on-chain.  As long as Ethereum is here, so will your NFTs.
 *
 *  Mint Price: 0.033 ETH
 *  
 *  Wen utility?  Wen staking?  
 *  Soon!  Specifically once half of the NFT's are sold!  These NFT's will be stakeable, and will reward users with ERC-20 token rewards.
 *  The protocol is all set, and once half of the NFT's are sold the staking will be launched.  At least half of the minting fees will be
 *  used for token liquidity and incentives for the community.
 *
 *  Twitter: @spacesquiggleznft
 *  Telegram: https://t.me/spacesquiggleznft
 *  Website: https://spacesquiggleznft.com
 *
 */
...
contract SPACESQUIGGLEZ is  ERC721URIStorage, ERC721Enumerable, Ownable, IERC2981 { 
    uint256  gen_c; 
    ...
    //bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
    constructor () ERC721 ("spacesquigglez","spsq") {
        ...
        nucleotide_m = 42;
        gen_b = 500;        
        nucleotide_cl = ["#567CFF", "#8EA8FF", "#7AF8FF", "#D875FF", "#8D4BE0", "#0FF0FC", "#BC13FE", "#8A2BE2", "#FF3131", "#FF5E00", "#39FF14"];
    ...
    function generate () public payable {
        require(gen_c <= gen_ts, "Genesis completed");
    ...
    function generateGiveaway () public onlyOwner {
        require(gen_c <= gen_ts, "Genesis completed");
        _safeMint (msg.sender , gen_c);
        string memory nucleotide_c = nucleotide_cl[(r+(nucleotide_cl.length+1)) % nucleotide_cl.length];
        string memory gen_m = gen_load(nucleotide_c) ;
    ...
    function gen_format(string  memory _gen_t, string memory _gen_name, uint256 _gen_c) internal pure returns (string memory) {
        ...
        return string(abi.encodePacked(base,Base64.encode(bytes(abi.encodePacked('{"name": "', _gen_name,'", ','"description": "GEO N0:',c_t(_gen_c),'", ','"attributes": "", ','"image": "', _gen_t,'"}')))));
    }    
