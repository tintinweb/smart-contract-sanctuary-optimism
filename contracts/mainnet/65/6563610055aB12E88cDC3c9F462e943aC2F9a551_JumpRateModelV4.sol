...
contract JumpRateModelV4 is InterestRateModel {
     ...
     */
    constructor(uint blocksPerYear_, uint baseRatePerYear, uint multiplierPerYear, uint jumpMultiplierPerYear, uint kink_, address owner_, string memory name_) public {
