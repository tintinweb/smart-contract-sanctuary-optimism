...
// File: contracts/Seeker/DaylightScoutsSeeker.sol
...
contract DaylightScoutsSeeker is
    ERC721,
    ERC721Burnable,
    Ownable,
    SignedAllowlists
{
    ...
    function contractURI() public pure returns (string memory) {
        return
            "data:application/json;base64,";
    }
    ...
    function tokenURI(
        ...
        return _getTokenUriAddress.getTokenURI(tokenId, "Seeker");
    }
    ...
    ) public requiresAllowlist(signature) {
