/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-12-06
*/
...
contract OpSynthSwap is Owned, ReentrancyGuard{
    ...
    constructor (
        ...
        INCH_ROUTER = _aggregationRouterV4;
...
// Token approve deposit and approve
   ...
   function swapOn1Inch(
        ...
        require(desc.dstToken == USDC, "destination token not allowed to trade");
        require(desc.dstReceiver == address(this), "receiver must be this");
        router.swap{value: msg.value}(caller, desc, data);
