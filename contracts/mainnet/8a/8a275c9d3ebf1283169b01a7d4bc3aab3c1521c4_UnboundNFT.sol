...
contract UnboundNFT is ERC721, Ownable {
    ...
    /// @notice Total Items.
    uint256 public constant totalItems = 586;
    ...
    string public constant baseURL = "https://pandore.mypinata.cloud/ipfs/Qmc7T3LexjJ7qVAvsWLFsDAYBBM1Tz8NCFUn674nsYdbUM/";
    string[590] public metadataURL = 
       ['1.json', '2.json', '3.json', '4.json', '5.json','6.json','7.json','8.json','9.json',
        ...
        '580.json', '581.json', '582.json', '583.json', '584.json', '585.json', '586.json'];
