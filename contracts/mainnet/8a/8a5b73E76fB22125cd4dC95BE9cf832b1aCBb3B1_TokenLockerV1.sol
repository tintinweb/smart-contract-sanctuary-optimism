...
contract TokenLockerManagerV1 is ITokenLockerManagerV1, Ownable {
  ...
  uint256 public minCost = 20000000000000000;
  ...
  function setMinCost(uint256 value) external onlyOwner {
    minCost = value;
  }

  function setFeeReceiver(address newReceiver) external onlyOwner {
    require(newReceiver != address(0), "New Receiver cannot be zero");
  ...
  function createTokenLocker(
    ...
    require(msg.value >= minCost, "Less than min amount");
