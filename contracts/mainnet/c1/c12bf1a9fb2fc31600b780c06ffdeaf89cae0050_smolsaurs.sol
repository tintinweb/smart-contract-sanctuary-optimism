...
// File: contracts/smolsaurs.sol

pragma solidity ^0.8.7;

contract smolsaurs is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    address rawrDAOMultiSig = 0xABA96619B891aD24ffCAFA3E05630F968B21E89a;
    string private baseURI;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT_OPTIMISM = 156;

    uint256 gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("smolsaurs", "saurs")
    {
        _owner = msg.sender;
    ...
    // mint function, max 2 per transaction
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        endpoint.send{value: msg.value}(
            ...
            address(0x0), // 'zeroPaymentAddress' unused for this
    ...
    function withdraw(uint256 amt) external onlyOwner {
        uint256 _each = amt / 2;
        require(payable(_owner).send(_each));
        require(payable(rawrDAOMultiSig).send(_each));
    }
