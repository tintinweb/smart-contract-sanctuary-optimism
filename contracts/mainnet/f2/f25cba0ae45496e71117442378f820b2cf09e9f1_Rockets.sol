/**
 *Submitted for verification at optimistic.etherscan.io on 2022-05-02
*/
...
contract Rockets is ERC721PresetMinterPauserAutoId {
    ...
    uint256 public maxSupply = 10277;
    ...
    ) ERC721PresetMinterPauserAutoId(_name, _symbol, _initNotRevealedUri) {
    ...
    function ownerMint(uint256 count) public onlyRole(DEFAULT_ADMIN_ROLE) {
        uint256 supply = totalSupply();
    ...
    function batchMintTo(address[] memory list) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function setPresale(bool state) public onlyRole(DEFAULT_ADMIN_ROLE) {
        presale = state;
    }

    function setPresaleCost(uint256 price) public onlyRole(DEFAULT_ADMIN_ROLE) {
        preCost = price;
    }
    ...
    function withdraw() public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        Address.sendValue(payable(msg.sender), royalty);
    }
    ...
    function reveal(bool state) public onlyRole(DEFAULT_ADMIN_ROLE) {
        revealed = state;
    }
