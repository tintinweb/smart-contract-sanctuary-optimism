...
contract StakingPool is Ownable {
    ...
    uint256 public rewardsDuration = 112 weeks;
    ...
    function setReward() external onlyOwner updateReward(address(0)) {
        uint256 reward = IERC20(token).allowance(msg.sender, address(this));
