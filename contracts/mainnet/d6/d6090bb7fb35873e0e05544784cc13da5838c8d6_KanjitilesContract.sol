...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x255153831a2f910f794506177334e6c287E79c8b];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 2136 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeia7eyuolyv3cxtfw3j3srg5bmnmxab7vuyykibcnifh7o2cb4yyfa/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2136");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2136");
...
// File: contracts/KanjitilesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KanjitilesContract is RamppERC721A {
    constructor() RamppERC721A("KANJI TILES", "KANJITILES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qv2WJyf3BTmQqLWUtCKl/contract-metadata";
    }
}
