...
contract MagicSaddle is ERC721A, Ownable {
    ...
    constructor() ERC721A ("Magic Saddle", "MS") {
    ...
    function MagicSaddleMint(uint256 _quantity) external callerIsUser payable {
