...
contract MerkleClaimERC20 {
    ...
    /// @param airdropToken ERC-20 target token that will be sent to this contract for the airdrop
    /// @param _merkleRoot of claimees
    /// @dev Make sure to check these values on-chain after deployment before proceeding with the airdrop
    function initialize(address airdropToken, bytes32 _merkleRoot) external {
        require(!initialized);
        airdropBonusToken = airdropToken;
