 ...
 */
contract SchemaRegistryUpgradeable is ISchemaRegistryUpgradeable, Semver, Initializable {
    error AlreadyExists();
    ...
    /**
     * @dev Creates a new SchemaRegistryUpgradeable instance.
     */
    ...
    /**
     * @inheritdoc ISchemaRegistryUpgradeable
     */
    function register(string calldata schema, ISchemaResolver resolver, bool revocable) external returns (bytes32) {
