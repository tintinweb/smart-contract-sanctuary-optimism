...
/// @notice An ERC-721 contract requires a signature from an NFT chip to mint
...
contract CatchMeCard is Ownable, ERC721A, IERC2981 {
    ...
    /// @notice Final time to be able to mint the NFT (June 25th, 2023 @8pm PST)
    uint32 public endTime = 1687748400;
    ...
    /// @notice Construct CatchMeCard with the given parameters
    ...
    ) ERC721A("Catch Me If You Can", "CATCH"){
    ...
    function tokenURI(
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "Catch Me If You Can ', tokenId.toString(), '",',
