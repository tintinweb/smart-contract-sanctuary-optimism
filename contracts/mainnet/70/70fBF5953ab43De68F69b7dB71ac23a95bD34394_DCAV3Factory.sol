...
contract DCAV3Factory {
    ...
    address public constant ROOBEE = 0xA31B1767e09f842ECFd4bc471Fe44F830E3891AA;
    ...
    function createDCA(
        ...
        require(tokenIn == ROOBEE, 'DCAFactory: Should get ROOBEE token');
        require(params.recipient == treasury, 'DCAFactory: Treasury should be recipient');
        require(params.amountOut == price, 'DCAFactory: Wrong amount of ROOBEE');
    ...
    function createDCAWithRoobee(
        ...
        //TODO for tests
        //TransferHelper.safeTransferFrom(ROOBEE, msg.sender, treasury, price);
        newDcaProxy =  _deployDCA(newOwner, initialPosition);
        return newDcaProxy;
    }
