...
contract DebankEA is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // ================== CONSTRUCTOR ===========================
    constructor() ERC721("Debank Early Adopters", "DEA") {}
        ...
        for (uint256 i = 0; i < _quantity; i++) {
            ...
            if (tokenId <= 500) {
                ...
                if (msg.value > 0.0005 ether) {
                    (bool success, ) = payable(msg.sender).call{value: msg.value - 0.0005 ether}("");
