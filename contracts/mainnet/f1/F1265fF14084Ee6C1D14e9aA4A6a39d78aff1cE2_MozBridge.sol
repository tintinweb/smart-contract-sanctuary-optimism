...
contract Vault is Ownable {
    ...
    function _takeSnapshot() internal returns (MozBridge.Snapshot memory snapshot) {
        ...
        snapshot.totalStablecoin = _totalAssetMD + _totalStablecoinMD;
...
contract Controller is Ownable {
    ...
    function _updateStats() internal {
        ...
        for (uint i; i < supportedChainIds.length ; ++i) {
            ...
            totalDepositAmount = totalDepositAmount + report.depositRequestAmount;
        }
        totalCoinMD = totalCoinMD >= totalDepositAmount ? totalCoinMD - totalDepositAmount : 0;
