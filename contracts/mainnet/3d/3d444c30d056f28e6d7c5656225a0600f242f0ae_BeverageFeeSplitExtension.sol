...
// File: contracts/interfaces/IStreamingFeeModule.sol
...
// File: contracts/interfaces/IIssuanceModule.sol
...
// File: contracts/interfaces/IBaseManager.sol
...
// File: contracts/adapters/BeverageFeeSplitExtension.sol
...
contract BeverageFeeSplitExtension is BaseExtension {
     ...
     */
    function updateIssueFee(ISetToken _setToken, IIssuanceModule _issuanceModule, uint256 _newFee)
        external
        onlyOperator
    {
        bytes memory callData = abi.encodeWithSignature("updateIssueFee(address,uint256)", _setToken, _newFee);
        invokeManager(address(_issuanceModule), callData);
    }
     ...
     */
    function updateRedeemFee(ISetToken _setToken, IIssuanceModule _issuanceModule, uint256 _newFee)
        external
        onlyOperator
    {
     ...
     */
    function updateFeeRecipient(ISetToken _setToken, IIssuanceModule _issuanceModule, address _newFeeRecipient)
        external
        onlyOperator
    {
