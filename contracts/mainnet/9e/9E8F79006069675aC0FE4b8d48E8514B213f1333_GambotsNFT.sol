...
contract GambotsNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "GamBots";
  string private constant TOKEN_SYMBOL = "GAMBOTS";
