...
contract HyperLPool is IUniswapV3MintCallback, HyperLPoolStorage, IHyperLPool {
    ...
    function rebalance(
        ...
        uint128 liquidity = getLiquidity();
        _rebalance(liquidity, feeAmount, paymentToken, hyperDex, msgData);
    ...
    function _rebalance(
        ...
        _deposit(lowerTick, upperTick, leftover0, leftover1, hyperDex, msgData);
    }
    ...
    function _deposit(
        ...
        _swapAndDeposit(amount0, amount1, hyperDex, msgData);
    }
    ...
    function _swapAndDeposit(
        ...
        finalAmount0 =
            amount0 -
            (amount0Before - token0.safeBalanceOf(address(this)));
        finalAmount1 =
            amount1 -
            (amount1Before - token1.safeBalanceOf(address(this)));
    }
