/**
 *Submitted for verification at optimistic.etherscan.io on 2022-05-17
*/
...
// File: contracts/nb4-optimistic.sol
...
contract nb4 is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 614;
    uint256 MAX_MINT_OPTIMISTIC = 634;
    uint256 maxMint = 2;
    ...
    function free_mint(uint8 numTokens) external {
        ...
        require(
            nextTokenId + numTokens <= MAX_MINT_OPTIMISTIC,
