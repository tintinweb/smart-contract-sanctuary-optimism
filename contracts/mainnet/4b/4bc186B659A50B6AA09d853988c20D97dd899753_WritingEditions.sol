    ...
    IWritingEditionEvents
{
    ...
    function initialize(
        ...
        // assumes the correct value was sent through the factory
        _purchase(recipient);
    }
    ...
    function contractURI() external view override returns (string memory) {
        return
            renderer != address(0)
                ? IRenderer(renderer).contractURI()
                : string(abi.encodePacked("ipfs://", _contractURI));
    }
