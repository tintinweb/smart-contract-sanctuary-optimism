...
contract BaseRewardPool is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event RequestWithdrawn(address indexed user, uint256 unlockTime, uint256 amount);
    ...
    function setUnlockTime(uint256 unlockTime_) external onlyOwner {
        unlockTime = unlockTime_;
    }
    ...
    function requestWithdrawn(uint256 amount)
    public
    updateReward(msg.sender)
    {
        require(amount > 0, 'RewardPool : Cannot withdraw 0');

        unstakeTime[msg.sender] = block.timestamp + unlockTime;
        unstakeAmount[msg.sender] += amount;
        emit RequestWithdrawn(msg.sender, unstakeTime[msg.sender], amount);
    ...
    function withdraw() external {
        ...
        stakingToken.safeTransfer(msg.sender, unstakeAmount[msg.sender]);
        emit Withdrawn(msg.sender, unstakeAmount[msg.sender]);
