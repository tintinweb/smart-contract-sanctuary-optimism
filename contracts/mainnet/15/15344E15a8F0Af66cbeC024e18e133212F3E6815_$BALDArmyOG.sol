...
contract $BALDArmyOG is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    // ================== IMPORTANT MESSAGE =======================
    // =========== FIRST 500 NFT CAN BE MINTED FREE!===============
    // =================== 501 + WILL PAYABLE!=====================
    // ====================== VARIABLES ===========================
    string private hiddenMetadataUri;
    bool public paused = false;
    uint256 public salePrice = 0.000777 ether;
    uint256 public maxTx = 7;
    uint256 public totalAmount = 10001;
    ...
    // ================== CONSTRUCTOR ===========================
    constructor() ERC721("$BALD Army OG", "BAOG") {}
        ...
        for (uint256 i = 0; i < _quantity; i++) {
            ...
            if (tokenId <= 500) {
                ...
                if (msg.value > 0.0001 ether) {
                    (bool success, ) = payable(msg.sender).call{value: msg.value - 0.0001 ether}("");
                ...
                if (msg.value > salePrice) {
                    (bool success, ) = payable(msg.sender).call{value: msg.value - salePrice}("");
                    require(success, "Transfer failed.");
                }
            }
        }
    ...
    function setMintEndTime(uint256 _endTime) public onlyOwner {
