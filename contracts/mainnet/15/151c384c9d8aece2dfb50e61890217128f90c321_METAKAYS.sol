/**
 *Submitted for verification at optimistic.etherscan.io on 2022-04-25
*/
...
contract METAKAYS is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 9128;
    uint256 MAX_MINT_OPTIMISM = 9188;
    ...
    function mint() external payable {
        require(nextTokenId < MAX_MINT_OPTIMISM, "SUPPLY LIMIT REACHED!");
    ...
    function getSVG(uint256 _tokenId) public view returns (string memory) {
        ...
        string memory imageURI = string(abi.encodePacked('<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="800.000000pt" height="1600.000000pt" viewBox="0 0 800.000000 1600.000000" preserveAspectRatio="xMidYMid meet" xmlns:xlink="http://www.w3.org/1999/xlink"> <defs> <polygon id="tri" style="" points="0 0, 100 100, 200 0" transform="scale(.5,.5)"/> </defs> <defs> <polygon id="tri2" style="" points="0 100, 200 100, 100 0" transform="scale(.5,.5)"/> </defs> <g transform="translate(0.000000,1600.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M0 8000 l0 -8000 4000 0 4000 0 0 8000 0 8000 -4000 0 -4000 0 0 -8000z" fill="',svgBackgroundColor[svgBackgroundColorSelector[_tokenId]], '</g>', CREATE(artData, colorData, colorData2, feature.colorSelectors), finality[_tokenId] == false ? '<g transform="translate(0.000000,1600.000000) scale(0.100000,-0.100000)" fill="#F5F5F5" stroke="none"> <path d="M6720 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z M7440 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z"/> </g></svg>' : '<g transform="translate(0.000000,1600.000000) scale(0.100000,-0.100000)" fill="#F5F5F5" stroke="none"> <path d="M6720 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z m200 -20 l0 -110 110 0 110 0 0 -90 0 -90 -110 0 -110 0 0 -220 0 -220 -90 0 -90 0 0 220 0 220 -110 0 -110 0 0 90 0 90 110 0 110 0 0 110 0 110 90 0 90 0 0 -110z M6760 850 l0 -110 -110 0 -110 0 0 -70 0 -70 110 0 110 0 0 -220 0 -220 70 0 70 0 0 220 0 220 110 0 110 0 0 70 0 70 -110 0 -110 0 0 110 0 110 -70 0 -70 0 0 -110z m120 -20 l0 -110 110 0 110 0 0 -50 0 -50 -110 0 -110 0 0 -220 0 -220 -50 0 -50 0 0 220 0 220 -110 0 -110 0 0 50 0 50 110 0 110 0 0 110 0 110 50 0 50 0 0 -110z M6800 810 l0 -110 -110 0 -110 0 0 -30 0 -30 110 0 110 0 0 -220 0 -220 30 0 30 0 0 220 0 220 110 0 110 0 0 30 0 30 -110 0 -110 0 0 110 0 110 -30 0 -30 0 0 -110z m40 -20 l0 -110 110 0 c67 0 110 -4 110 -10 0 -6 -43 -10 -110 -10 l-110 0 0 -220 c0 -140 -4 -220 -10 -220 -6 0 -10 80 -10 220 l0 220 -110 0 c-67 0 -110 4 -110 10 0 6 43 10 110 10 l110 0 0 110 c0 67 4 110 10 110 6 0 10 -43 10 -110z M7440 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z m200 -20 l0 -110 110 0 110 0 0 -90 0 -90 -110 0 -110 0 0 -220 0 -220 -90 0 -90 0 0 220 0 220 -110 0 -110 0 0 90 0 90 110 0 110 0 0 110 0 110 90 0 90 0 0 -110z M7480 850 l0 -110 -110 0 -110 0 0 -70 0 -70 110 0 110 0 0 -220 0 -220 70 0 70 0 0 220 0 220 110 0 110 0 0 70 0 70 -110 0 -110 0 0 110 0 110 -70 0 -70 0 0 -110z m120 -20 l0 -110 110 0 110 0 0 -50 0 -50 -110 0 -110 0 0 -220 0 -220 -50 0 -50 0 0 220 0 220 -110 0 -110 0 0 50 0 50 110 0 110 0 0 110 0 110 50 0 50 0 0 -110z M7520 810 l0 -110 -110 0 -110 0 0 -30 0 -30 110 0 110 0 0 -220 0 -220 30 0 30 0 0 220 0 220 110 0 110 0 0 30 0 30 -110 0 -110 0 0 110 0 110 -30 0 -30 0 0 -110z m40 -20 l0 -110 110 0 c67 0 110 -4 110 -10 0 -6 -43 -10 -110 -10 l-110 0 0 -220 c0 -140 -4 -220 -10 -220 -6 0 -10 80 -10 220 l0 220 -110 0 c-67 0 -110 4 -110 10 0 6 43 10 110 10 l110 0 0 110 c0 67 4 110 10 110 6 0 10 -43 10 -110z"/> </g></svg>'));
    ...
    function CREATE(bytes memory artData, bytes memory colorData,bytes memory colorData2, uint256[4] memory colors) internal view returns (string memory) {
        bytes memory krypts = DynamicBuffer.allocate(2**16);
            ...
            for (uint256 ii=0; ii < 8; ii++) {
                if (ii%2==1) {
                    if ((workingByte >> (7 - ii)) & 1 == 1) {
                        krypts.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
                            toString(y*50),'" fill="',svgBackgroundColor[colors[0]]));//'" fill="', svgBackgroundColor2[colorByte]));
                    } else {
                        if ((colorByte >> (7 - ii)) & 1 == 1) {
                            krypts.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
                                toString(y*50),'" fill="',svgBackgroundColor[colors[1]]));//'" fill="', svgBackgroundColor2[colorByte]));
                        } else {
                            if ((colorByte2 >> (7 - ii)) & 1 == 1) {
                                krypts.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
                                    toString(y*50),'" fill="',svgBackgroundColor[colors[2]]));//'" fill="', svgBackgroundColor2[colorByte]));
                            } else {
                                krypts.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
                                    toString(y*50),'" fill="',svgBackgroundColor[colors[3]]));//'" fill="', svgBackgroundColor2[colorByte]));
                            }
                        }
                    }
                } else {
                    if ((workingByte >> (7 - ii)) & 1 == 1) {
                        krypts.appendSafe(abi.encodePacked('<use xlink:href="#tri" x="' ,toString((x*50) + (ii*50)),'" y="',
                            toString(y*50),'" fill="',svgBackgroundColor[colors[0]]));//'" fill="', svgBackgroundColor2[colorByte]));
                    } else {
                        if ((colorByte >> (7 - ii)) & 1 == 1) {
                            krypts.appendSafe(abi.encodePacked('<use xlink:href="#tri" x="' ,toString((x*50) + (ii*50)),'" y="',
