/**
 *Submitted for verification at optimistic.etherscan.io on 2022-03-28
*/
...
contract QuixoticLaunchpadERC721 is ERC721("Layer2DAO Early Adopter - Level 2", "L2DAO-LVL2"), ERC721Enumerable, Ownable {

    string private _baseURIextended;
    bool public frozenMetadata = false;
    uint256 public MAX_TOKENS = 84239;
    uint256 public constant maxMintPerTxn = 1;
    ...
    function mintToken(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxMintPerTxn, "Exceeded max mint per transaction");
