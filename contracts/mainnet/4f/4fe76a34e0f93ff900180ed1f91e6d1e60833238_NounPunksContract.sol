/**
 *Submitted for verification at optimistic.etherscan.io on 2022-04-17
*/
...
//
//            _   __                  ____              __       
//    / | / /___  __  ______  / __ \__  ______  / /_______
//   /  |/ / __ \/ / / / __ \/ /_/ / / / / __ \/ //_/ ___/
//  / /|  / /_/ / /_/ / / / / ____/ /_/ / / / / ,< (__  ) 
// /_/ |_/\____/\__,_/_/ /_/_/    \__,_/_/ /_/_/|_/____/  
//                                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 100, 9969 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeig2yhwmttocf7bjog2xbbq6oicbwvrppv6dedvxwoazpkajt2maba/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9969");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9969");
...
// File: contracts/NounPunksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NounPunksContract is RamppERC721A {
    constructor() RamppERC721A("NounPunks", "NOUNPUNKS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/2cMxz09Y3SG2Djsul8NH/contract-metadata";
    }
}
