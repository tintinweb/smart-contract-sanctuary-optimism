...
contract BountiesMetaTxRelayer {
  ...
  function metaIssueBounty(
    ...
    replayNonce[signer]++;
    return bountiesContract.issueBounty(payable(signer),
                                         _issuers,
                                         _approvers,
                                         _data,
                                         _deadline,
  ...
  function metaIssueAndContribute(
    ...
    if (msg.value > 0){
      return bountiesContract.issueAndContribute{ value: msg.value }(payable(signer),
                                                 _issuers,
                                                 _approvers,
                                                 _data,
                                                 _deadline,
      ...
      return bountiesContract.issueAndContribute(payable(signer),
                                                 _issuers,
                                                 _approvers,
                                                 _data,
                                                 _deadline,
  ...
  function metaContribute(
    ...
    if (msg.value > 0){
      bountiesContract.contribute{ value: msg.value }(payable(signer), _bountyId, _amount);
    } else {
      bountiesContract.contribute(payable(signer), _bountyId, _amount);
    }
  }
  ...
  function metaDrainBounty(
    ...
    bytes32 metaHash = keccak256(abi.encode(address(this),
                                                  ...
                                                  _amounts,
                                                  _nonce));
    address payable signer = payable(getSigner(metaHash, _signature));
