...
//*********************************************************************//
//
//     __   ___      _   ______________   ____  ______
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1673265600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1673264700;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 18499) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicqjg5iccx526ghwb4khgwhh3cvedmljhp6evnkcer34o4wjw4ruy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/uO3FgPRbO1uY6l3HzrMW/contract-metadata";
  }
...
// File: contracts/L2NftogContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract L2NftogContract is RamppERC721A {
    constructor() RamppERC721A("L2 NFT OG", "L2NFTOG"){}
}