/**
 *Submitted for verification at optimistic.etherscan.io on 2022-04-10
*/
...
contract TheMeld is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 950;
    uint256 MAX_MINT_OPTIMISM = 1000;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_OPTIMISM, "Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, string(abi.encodePacked("You have to send some/more oETH to cover traversal gas fee estimate. You will be refunded the difference. Estimate: ", Strings.toString(messageFee))));
