...
import {
    OptimismFeeCollectorInterface,
    WrappedInterface
} from "./interfaces/OptimismFeeCollectorInterface.sol";

/**
 * @title   OptimismFeeCollector
 * @author  OpenSea Protocol Team
 * @notice  OptimismFeeCollector is a contract that is used as an
 ...
 */
contract OptimismFeeCollector is
    BaseFeeCollector,
    OptimismFeeCollectorInterface
{
...
/**
 * @title   OptimismFeeCollectorInterface
 * @author  OpenSea Protocol Team
 * @notice  OptimismFeeCollectorInterface contains all external function
 *          interfaces for the fee collector implementation.
 */
interface OptimismFeeCollectorInterface {
    /**
     * @notice Unwraps and withdraws the given amount of wrapped tokens from the
     *         provided contract address. Requires the caller to have the
     *         operator role, and the withdrawal wallet to be in the
