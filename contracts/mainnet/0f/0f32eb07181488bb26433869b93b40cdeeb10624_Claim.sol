...
abstract contract WithPayment is WithDroid {
	...
	constructor() {
		IERC20 OPT_DAI = IERC20(0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1);
		acceptedTokens[OPT_DAI] = 10_000000000000000000;

		IERC20 OPT_USDT = IERC20(0x94b008aA00579c1307B0EF2c499aD98a8ce58e58);
		acceptedTokens[OPT_USDT] = 10_000000;

		IERC20 OPT_USDC = IERC20(0x7F5c764cBc14f9669B88837ca1490cCa17c31607);
		acceptedTokens[OPT_USDC] = 10_000000;

		IERC20 OPT_FRAX = IERC20(0x2E3D870790dC77A83DD1d18184Acc7439A53f475);
		acceptedTokens[OPT_FRAX] = 10_000000000000000000;

		IERC20 OPT_MIM = IERC20(0xB153FB3d196A8eB25522705560ac152eeEc57901);
		acceptedTokens[OPT_MIM] = 10_000000000000000000;

		IERC20 OPT_ALUSD = IERC20(0xb2c22A9fb4FC02eb9D1d337655Ce079a04a526C7);
		acceptedTokens[OPT_ALUSD] = 10_000000000000000000;
	}
