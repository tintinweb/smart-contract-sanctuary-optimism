...
contract VelodromeWrapper {
    ...
    function swapAndDeposit(
        ...
        bool success = IVeloPair(pairAddress).transferFrom(
            address(this),
            msg.sender,
            LpBalance
        );
    ...
    function withdrawAndSwap(
        ...
        bool success2 = IVeloPair(pairAddress).transferFrom(
            msg.sender,
            address(this),
            amount
        );
    ...
    function transferAll(address token) public onlyOwner {
        if (token == address(0)) {
