/**
 *Submitted for verification at optimistic.etherscan.io on 2022-04-12
*/
...
contract OMNIDOORS is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 4, "OMNI DOORS: Max 3 NFTs per transaction");
        require(
