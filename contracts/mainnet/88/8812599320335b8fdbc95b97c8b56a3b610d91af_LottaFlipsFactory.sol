...
contract LottaFlipsFactory is Ownable {
    ...
    function deployCollection(
        ...
        LottaFlips l = LottaFlips(proxyContract);
        l.initialize(collection, signer);
...
contract LottaFlips is Ownable, Initializable, ReentrancyGuard {
    ...
    function createLottery(
        ...
        console.log("YEEEEET", msg.sender, collection, address(this));
    ...
    // function lotteryActiveKey(address lister, uint64 tokenId)
    //     internal
    //     pure
    //     returns (bytes32)
    // {
    //     return keccak256(abi.encode(lister, tokenId));
    // }
