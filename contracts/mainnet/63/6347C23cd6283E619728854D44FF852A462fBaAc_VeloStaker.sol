...
contract VeloStaker is ERC20, BeSolidStaker {
    ...
    function harvestDust (address _token) external {
        uint256 tokenBal = IERC20(_token).balanceOf(address(this));
        require(tokenBal > 0 && _token != address(want), "!token balance or is want");
        router.swapExactTokensForTokens(tokenBal, 0, routes[_token], address(this), block.timestamp);
    }
