...
if (gn.isGenesisAddressLevel1(_from) || gn.isGenesisAddressLevel2(_from)) revert('You must upgrade to Level 3 to allow transfers. Visit https://optimism.minereum.com for more info');
