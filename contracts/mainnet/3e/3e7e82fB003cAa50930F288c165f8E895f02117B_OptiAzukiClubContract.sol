...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xcBcF1c25A275ACb7dF85e19776583c72cD838D0E];
  address public erc20Payable = 0xcBcF1c25A275ACb7dF85e19776583c72cD838D0E;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 5555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidbh3w4w42twdgul5jecciyv4nlycc3sbyeqrtbrsu4vbmwptpy4e/";
...
// File: contracts/OptiAzukiClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptiAzukiClubContract is RamppERC721A {
    constructor() RamppERC721A("Opti Azuki Club", "OAC"){}
}
