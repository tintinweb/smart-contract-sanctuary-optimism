...
contract Coralreef is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Coral reef", "CORAL") {
  ...
  uint256 public constant MAX_SUPPLY = 79;
