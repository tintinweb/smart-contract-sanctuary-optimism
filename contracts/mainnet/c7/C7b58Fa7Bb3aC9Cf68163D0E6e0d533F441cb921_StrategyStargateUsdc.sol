...
import "../strategy-stargate-farm-base.sol";

contract StrategyStargateUsdc is StrategyStargateFarmBase {
    // Token addresses
    address public constant _lp = 0xDecC0c09c3B5f6e92EF4184125D5648a66E35298;
...
import "../../interfaces/star-chef.sol";
import "../../interfaces/univ3/ISwapRouterOptimism.sol";
...
abstract contract StrategyStargateFarmBase is StrategyBase {
    ...
    // Token addresses
    address public constant stg = 0x296F55F8Fb28E498B858d0BcDA06D955B2Cb3f97;
    ...
    constructor(
        ...
        IERC20(stg).approve(univ3Router, type(uint256).max);
    ...
    function harvest() public override {
        ...
        // Liquidity exists for STG-USDC
        // If diff underlying, swap USDC -> underlying
        if (underlying == usdc) {
            path = abi.encodePacked(stg, poolFee, usdc);
        } else {
