...
contract AelinERC1155Test is ERC1155, ERC1155Supply, Ownable {
    uint256[] private supplies = [100, 100, 100];
    uint256[] private minted = [0, 0, 0];

    string public _name;
    string public _symbol;
    string public _baseExtension = ".mp4";

    constructor() ERC1155("https://www.coinage.media/nft/") {
      _name = "AelinERC1155Test";
      _symbol = "AELIN-ERC1155-TEST-2";
    ...
    function uri(uint256 _id) public view override returns (string memory) {
      ...
      return string(abi.encodePacked(super.uri(_id), Strings.toString(_id), _baseExtension));
    }
