    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmfAMHbDQvtG6DevezmbEPWWZAfJbiVGRfNpSBCXH85jAf/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/k4gR9uEKLWVoNNjFogii/contract-metadata";
  }
...
// File: contracts/OptimismDevilYachtClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptimismDevilYachtClubContract is RamppERC721A {
    constructor() RamppERC721A("Optimism Devil Yacht Club", "ODYC"){}
}
