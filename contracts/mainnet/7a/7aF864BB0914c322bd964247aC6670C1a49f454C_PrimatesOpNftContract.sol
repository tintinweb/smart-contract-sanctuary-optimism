...
//*********************************************************************//
//
//     ____       _                 __            ____           _   ______________
//    / __ \_____(_)___ ___  ____ _/ /____  _____/ __ \____     / | / / ____/_  __/
//   / /_/ / ___/ / __ `__ \/ __ `/ __/ _ \/ ___/ / / / __ \   /  |/ / /_    / /   
//  / ____/ /  / / / / / / / /_/ / /_/  __(__  ) /_/ / /_/ /  / /|  / __/   / /    
// /_/   /_/  /_/_/ /_/ /_/\__,_/\__/\___/____/\____/ .___/  /_/ |_/_/     /_/     
//                                                 /_/                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x236e06c7adf54fB293bED271CF614b6727659012];
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.00006 ether;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 1888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPokRD5R1bTtGckEjVpK5hx419YNiFpe4P74etz5tDFaw/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1888");
...
// File: contracts/PrimatesOpNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PrimatesOpNftContract is RamppERC721A {
    constructor() RamppERC721A("PrimatesOp NFT", "PRIMATES"){}
}
