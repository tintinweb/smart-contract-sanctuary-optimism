...
contract Dwarfs is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("8 Dwarfs", "8D") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 88;
  ...
  {
    return string(abi.encodePacked(super.tokenURI(tokenId), "8"));
  }
}
