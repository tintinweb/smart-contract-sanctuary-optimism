/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-02-06
*/
...
contract X7Magister is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    constructor(address mintFeeDestination_, address treasury_, address magisterDistributor) ERC721("X7 Magister (Optimism)", "oX7MAGISTER") Ownable(msg.sender) {
