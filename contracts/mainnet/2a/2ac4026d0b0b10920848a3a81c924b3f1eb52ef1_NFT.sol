...
contract NFT is ERC721BB {
    ...
    constructor() ERC721BB("4711 Optimism Genesis Node", "4711-OP-GENESIS", 1, 10) {
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(msg.value >= quantity * _price, "mint price not paid");
        require(_mintCounter + quantity < _maxSupply, "minted out");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return "data:json;base64,";
    }
}
