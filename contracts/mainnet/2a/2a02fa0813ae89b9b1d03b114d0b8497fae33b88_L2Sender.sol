...
contract L2Sender {
    address polygon_2inch_address;

    constructor(address _polygon_2inch_address) {
        polygon_2inch_address = _polygon_2inch_address;
    }

    function swap(uint256 amount, uint256 bonderFee) external {
