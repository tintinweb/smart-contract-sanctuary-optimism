/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-11-22
*/

//*********************************************************************//
//*********************************************************************//
//
//   ______   .______   .___________. __         .__   __.      ___      __    __  .___________.    _______.
//  /  __  \  |   _  \  |           ||  |        |  \ |  |     /   \    |  |  |  | |           |   /       |
// |  |  |  | |  |_)  | `---|  |----`|  |  ______|   \|  |    /  ^  \   |  |  |  | `---|  |----`  |   (----`
// |  |  |  | |   ___/      |  |     |  | |______|  . `  |   /  /_\  \  |  |  |  |     |  |        \   \    
// |  `--'  | |  |          |  |     |  |        |  |\   |  /  _____  \ |  `--'  |     |  |    .----)   |   
//  \______/  | _|          |__|     |__|        |__| \__| /__/     \__\ \______/      |__|    |_______/    
//                                                                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1668643200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1668621600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc124f20B727d777c533FF4bd37Dd5a79525AB662];
  address public erc20Payable = 0xc124f20B727d777c533FF4bd37Dd5a79525AB662;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0009 ether;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 3000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid2ewb7fpvidsjkkaqbhrcrduh4m5w5moawkieiodsp5ab6usc2ca/";
...
// File: contracts/OptiNautsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptiNautsContract is RamppERC721A {
    constructor() RamppERC721A("OptiNauts", "OPN"){}
}
