...
contract OmniOwls is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 1775;
    uint256 MAX_MINT_OPTIMISM = 1825;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "Max 2 Owls per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_OPTIMISM, "Owl Mint exceeds supply");
