/**
 *Submitted for verification at optimistic.etherscan.io on 2022-01-26
*/
...
contract CancelUtil is Ownable {
    ...
    */
    function cancelDutchAuctionOrder(
        uint256 exchangeVersion,
        address payable seller,
        address erc721address,
        uint256 tokenId,
        ...
        require(_validateDutchAuctionSignature(dutchAuctionOrder, signature), "Signature is not valid for DutchAuction.");
