...
contract BaseVault is CommonVault {
    ...
    function totalAssets() public view override returns (uint256) {
        ...
        // convert PERP accountValue to baseToken balance by spotTwap
        ...
        return base_bd.add(quote_qd.add(perpAccountValue_qd).mulDiv(10**baseToken.decimals(), spotTwap_qd));
    }
    ...
    function _requireMarginRatioBeforeOpenPosition(bool isBaseToQuote) internal view override {
        if (!isBaseToQuote) {
            // long on perp => baseVault increase position, check margin ratio
