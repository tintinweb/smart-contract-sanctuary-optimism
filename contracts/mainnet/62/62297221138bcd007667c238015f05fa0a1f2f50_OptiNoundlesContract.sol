...
//
//            ____        __  _    _   __                      ____         
//   / __ \____  / /_(_)  / | / /___  __  ______  ____/ / /__  _____
//  / / / / __ \/ __/ /  /  |/ / __ \/ / / / __ \/ __  / / _ \/ ___/
// / /_/ / /_/ / /_/ /  / /|  / /_/ / /_/ / / / / /_/ / /  __(__  ) 
// \____/ .___/\__/_/  /_/ |_/\____/\__,_/_/ /_/\__,_/_/\___/____/  
//     /_/                                                          
//     
//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 7465 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiclhn3zwaqbb372thm4egs3fdpb4py32tnsdackoqihjeeo4aof7u/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 7465");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 7465");
...
// File: contracts/OptiNoundlesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptiNoundlesContract is RamppERC721A {
    constructor() RamppERC721A("Opti Noundles", "ONOUNDLES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/m4PiYSUv4c4ZrY8Wtqdu/contract-metadata";
    }
}
