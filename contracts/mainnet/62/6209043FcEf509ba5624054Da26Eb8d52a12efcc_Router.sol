...
contract Router {
    ...
    address private constant _ELECTION_INSPECTOR_MODULE = 0x9099A250b5583235F7Bb5D9aDF1EaF97fF20EE5C;
    address private constant _ELECTION_MODULE = 0x3FB0c5c54f1De3BD8083C6a0f21701D36a004aD3;
            ...
            function findImplementation(sig) -> result {
                ...
                if lt(sig,0xca80a2ed) {
                    if lt(sig,0xaeff252a) {
                        ...
                        case 0xae92a076 { result := _ELECTION_MODULE } // ElectionModule.setDebtShareSnapshotId()
                        leave
                    }
                    switch sig
