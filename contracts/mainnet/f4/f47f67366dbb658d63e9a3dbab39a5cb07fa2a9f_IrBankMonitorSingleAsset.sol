/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-03-03
*/
...
contract IrBankMonitorSingleAsset {
    ...
    constructor(address _owner) {
        owner = _owner;
        irBankStrategy = 0x7dBC2e7a5e3aC6dd6773472642e3EFAEab0De3e9;// change irBankStrategy
        irbankOracle = 0x2424C30E589Caea191C06F41d1f5b90348dbeD7d;
        bandOracle = 0xDA7a001b254CD22e46d3eAB04d937489c93174C3;
        stakeRewardsHelper = IrBankStrategyInterface(irBankStrategy).pool(); //change stakeRewardsHelper
    ...
    function setStakeRewardsHelper(address _stakeRewardsHelper) external {
        require(msg.sender == owner, " only owner set Stake Rewards Helper");
    ...
    function _getPtokenInternal(address _underlying)
        internal
        view
        returns (address)
    {
    ...
    function _getStakeRewardInternal(address _underlying)
        internal
        view
        returns (address)
    {
    ...
    function _getBaseUintInternal(address _underlying)
        internal
        view
        returns (uint256)
    {
    ...
    function getUnderlyingConfig(address _underlying)
        external
        view
        returns (
            address,
