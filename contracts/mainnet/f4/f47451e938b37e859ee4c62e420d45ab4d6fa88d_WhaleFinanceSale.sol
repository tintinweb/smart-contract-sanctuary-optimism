...
contract WhaleFinanceSale {
    ...
    uint256 public immutable presalePrice = 500000000 * 1e18;
    ...
    address public  ROUTER = 0x9c12939390052919aF3155f41Bf4160Fd3666A6f;

    constructor(uint256 _startTime, uint256 _endTime, address _WHALE, uint256 _max) {
        owner = msg.sender;
    ...
    function claim() external {
        require(block.timestamp > endTime + 30 minutes, "Not claimable");
        ...
        IERC20(WHALE).transfer(msg.sender, amount);
    }
