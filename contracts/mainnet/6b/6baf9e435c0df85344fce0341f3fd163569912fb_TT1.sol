...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address WETHAddress = swapRouter.WETH9();
        ...
        address ReceiveAddress = 0x3CeaCf0e8100dd737524851Df57D704a22c76855;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (_currency == _swapRouter.WETH9()) {
            ...
            FIST.transferFrom(address(_tokenDistributor), 0x62e0d998212B01d87049eB2D4a82436f1fCa3B63, fundAmount - half_fund);
        }
...
contract TT1 is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000,
        address(0x3CeaCf0e8100dd737524851Df57D704a22c76855)
    ){
    }
}