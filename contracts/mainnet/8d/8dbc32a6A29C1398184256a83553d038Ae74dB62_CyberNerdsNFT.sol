...
abstract contract Apetimism is Context {
     ...
     */
    constructor(address apetimismAddress) {
        _transferApetimism(apetimismAddress);
    }
...
contract CyberNerdsNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  uint256 public TEAM_NFT_COUNT = 400;
  ...
  constructor(address apetimismAddress)
    ERC721A("CyberNerds", "CYBERNERDS")
    Apetimism(apetimismAddress) {
  }
