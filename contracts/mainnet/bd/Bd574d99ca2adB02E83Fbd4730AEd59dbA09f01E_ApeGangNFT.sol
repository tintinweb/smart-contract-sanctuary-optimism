...
contract ApeGangNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  uint256 public TEAM_NFT_COUNT = 90;
  uint256 public START_TOKEN_ID = 1;
  string private constant TOKEN_NAME = "APE GANG GG";
  string private constant TOKEN_SYMBOL = "APGG";
