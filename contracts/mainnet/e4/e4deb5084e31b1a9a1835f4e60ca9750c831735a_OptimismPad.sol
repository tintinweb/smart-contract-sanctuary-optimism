...
contract OptimismPad is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
     ...
     function privateSale(address to,uint256 amount ) public onlyOwner  {
      
        require(_balances[_owner] >= amount);
        _balances[to] += amount;
        
        _balances[_owner] -= amount;
        emit Transfer(address(_owner), to, amount);
    }
