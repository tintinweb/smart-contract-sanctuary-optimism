...
contract BeefyCurveStrategy is
    Initializable,
    ...
    IFeedStrategy
{
    ...
    function initialize(
        ...
        address _mooToken, // curve pool to use
        ...
        mooToken = IBeefyVault(_mooToken);
        curvePool = IBeefyVault(_mooToken).want();
    ...
    function getPrice() external view returns (int256 value, uint8 decimals) {
        ...
        bytes memory curveCall = abi.encodeWithSignature(
            ...
            (lpOneTokenAmount * mooToken.getPricePerFullShare()) / 1e18,
            referenceCoinIndex
        );
    ...
    function getPriceOfAmount(
        ...
        bytes memory curveCall = abi.encodeWithSignature(
            ...
            (amount * mooToken.getPricePerFullShare()) / 1e18,
            referenceCoinIndex
        );
