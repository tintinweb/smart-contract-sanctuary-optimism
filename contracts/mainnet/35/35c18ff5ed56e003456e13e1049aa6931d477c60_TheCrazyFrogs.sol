/**
 *Submitted for verification at optimistic.etherscan.io on 2022-07-13
*/
...
// File contracts/examples/TheCrazyFrogs.sol

pragma solidity 0.8.4;

contract TheCrazyFrogs is UniversalONFT721 {
    string private baseURI = "ipfs://QmPQ6CDeXeZdK6YZ1w42BAjZgJXZBKpd9Wb3TbNP3R3eaq/";
    bool private _swFreeMint = true;
    mapping(address => uint8) private _allowList;


    constructor(address _layerZeroEndpoint, uint _startMintId, uint _endMintId) UniversalONFT721("TheCrazyFrogs", "CF", _layerZeroEndpoint, _startMintId, _endMintId) {}

    function freeMint() external payable {
        require(_swFreeMint);
        require(nextMintId <= maxMintId, "TheCrazyFrogs: max mint limit reached");
        require(1 <= _allowList[msg.sender], "Only Allowed users");
      ...
      function setAllowList(address[] calldata addresses) public{
        require(0x75e7c123fB881940B8DCd39596C8a6E8696A3112 == msg.sender, "OnlyOwner");
