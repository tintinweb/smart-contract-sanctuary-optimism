...
/* 
BuildOnBase (BASE)      BuildOnBase (BASE)      BuildOnBase (BASE)
...
// BASE.
contract BASE is ERC20('BuildOnBase', 'BASE') {
    
    //Pre-minting of 10 billion tokens for initial BASE celebration
    constructor () public {
