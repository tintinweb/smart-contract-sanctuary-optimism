/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-02-09
*/
...
/**
 * @title  TokenOnion
 * @notice TokenOnion is a hash onion for distributing tokens.
 */
contract TransferOnion is ReentrancyGuard {
    ...
    function peel(Layer[] memory _layers) public nonReentrant {
        ...
        for (uint256 i = 0; i < length; ) {
            ...
            require(
                keccak256(abi.encode(layer.recipient, layer.amount, layer.shell)) == tshell,
                "TokenOnion: what are you doing in my swamp?"
            );
