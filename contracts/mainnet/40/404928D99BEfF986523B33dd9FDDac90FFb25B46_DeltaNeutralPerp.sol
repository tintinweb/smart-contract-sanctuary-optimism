...
contract DeltaNeutralPerp is StrategyStorage {
    ...
    address public constant vToken2 = address(0x8C835DFaA34e2AE61775e80EE29E2c724c6AE2BB); /// Native Strategy Perp Token
  ...
  */
    ...
    function _nativeStrategyTokenPrice(uint256 interval) private view returns (uint256) { // wBTC, wETH or other
        return IIndexPrice(vToken2).getIndexPrice(interval) / 1e12;
    }
    ...
    function getDailyMarketTwap() public onlyTrigger() view returns(uint256) {
        uint160 dailyMarketTwap160X96 = IExchange(_perp.getExchange()).getSqrtMarkTwapX96(vToken2, 60 * 60 * 1);
