...
contract ApexerciseNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "Apexercise";
  string private constant TOKEN_SYMBOL = "APEXERCISE";
