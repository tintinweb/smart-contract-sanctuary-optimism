...
import {IObservability, IObservabilityEvents} from "./Observability.sol";
    ...
    IObservabilityEvents
{
    ...
    function _purchase(address recipient, string memory message)
        internal
        returns (uint256 tokenId)
    {
