...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x48dC15A26232DA1b528e4b9D257589da111db07C];
...
// File: contracts/ModularNomadsMintPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract ModularNomadsMintPassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Modular Nomads Mint Pass";
    string public symbol = "MONOMP";
