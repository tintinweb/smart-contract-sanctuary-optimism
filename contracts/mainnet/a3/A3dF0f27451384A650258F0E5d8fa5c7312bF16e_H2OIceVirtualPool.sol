 ...
 * @notice Library includes signed and unsigned math to add or remove decimals
 *     as need to get the appropriate result.
*/

/// Unsigned Fixed Point.
library UFixedPoint {
    /**
     * @notice Multiplication of two 18 decimal numbers with 18 excess decimals
 ...
 * @return Result.
 */
function max(uint256 dA, uint256 dB) pure returns (uint256)
{
    return dA > dB ? dA : dB;
}
 ...
 * @return Result.
 */
function min(uint256 dA, uint256 dB) pure returns (uint256)
{
    return dA > dB ? dB : dA;
}
 ...
 * @return Result.
 */
function max(int256 dA, int256 dB) pure returns (int256)
{
    return dA > dB ? dA : dB;
}
 ...
 * @return Result.
 */
function min(int256 dA, int256 dB) pure returns (int256)
{
    return dA > dB ? dB : dA;
}
