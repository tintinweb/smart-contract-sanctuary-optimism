...
contract UniqueCoffeeNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "Unique Coffee";
  string private constant TOKEN_SYMBOL = "UCF";
