...
contract QHFeeder is Initializable, UUPSUpgradeable, OwnableUpgradeable, WardedUpgradeable, IFeeder {
    ...
    mapping (uint256 => int256) public tvl;
    ...
    function newFund(uint256 fundId,
        ...
        uint256 minWithdrawalAmount) external override auth {
    ...
    function stake(uint256 fundId, address user, uint256 amount) external override auth returns (uint256 stakedAmount) {
        ...
        tvl[fundId] += int256(left);
        setUserAccrual(fundId, user, int256(left));
    ...
    function withdraw(uint256 fundId, address user) public override auth {
        require(managers[fundId] != address(0x0), "QHFeeder/fund-not-init");
    ...
    function drip(uint256 fundId, address trader) external override auth {
        require(managers[fundId] != address(0x0), "QHFeeder/fund-not-init");
    ...
    function setUserAccrual(uint256 fundId, address user, int256 amount) internal returns(int256) {
    ...
    function getUserAccrual(uint256 fundId, address user) internal view returns (int256) {
