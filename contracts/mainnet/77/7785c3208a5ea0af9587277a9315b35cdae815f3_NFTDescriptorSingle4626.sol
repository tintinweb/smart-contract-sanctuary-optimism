...
contract NFTDescriptorSingle4626 is NFTDescriptor {
    ...
    {
        IERC4626 vault = IERC4626(vars.underlying);
        IERC20Metadata asset = IERC20Metadata(vault.asset());

        vars.underlyingSymbol = asset.symbol();
        vars.amount = generateDecimalString(vault.convertToAssets(vars.position.amount), asset.decimals());
        ...
        text = string.concat(
            ...
            '<rect x="65" y="657" width="470" height="59" rx="10" fill="#DEDCE0"/>'
