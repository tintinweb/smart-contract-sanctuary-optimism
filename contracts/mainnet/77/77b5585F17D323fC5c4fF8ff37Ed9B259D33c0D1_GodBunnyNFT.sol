...
contract GodBunnyNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  uint256 public MAX_SUPPLY = 792;
  uint256 public TEAM_NFT_COUNT = 0;
  uint256 public START_TOKEN_ID = 1;
  string private constant TOKEN_NAME = "God Bunny";
  string private constant TOKEN_SYMBOL = "GODBUNNY";
