...
contract JustBananaNFT is ERC721A, Ownable, Pausable {
  ...
  uint256 public RESERVED_NFT_COUNT = 500;
  ...
  constructor() ERC721A("JustBanana", "JUSTBANANA") {
  }
  ...
  function mint(uint256 quantity, int8 role, uint256 nonce, uint8 v, bytes32 r, bytes32 s) external payable whenNotPaused {
  ...
  function maxMintableForRole(address addr, int8 role) public view virtual returns (uint256) {
    ...
    return wallet_quota_left < round_quota_left ? wallet_quota_left : round_quota_left;
  }
