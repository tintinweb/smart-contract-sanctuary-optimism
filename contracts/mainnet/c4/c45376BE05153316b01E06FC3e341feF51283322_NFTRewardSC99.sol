...
interface InterfaceReward {
    ...
    function claimableRewardBatch(uint256[] memory) external view returns(uint256[] memory);
    function claimRewardBatch(uint256[] memory) external returns(uint256[] memory);
