...
contract NukeVault is ERC20, IERC4626, Governable, Pausable {
    ...
    function withdraw(
        ...
        // require(actualAssetsWithdrawn >= assets, "Not enough shares"); // TODO: must discuss how we are supposed to police this (MUST revert if all of assets cannot be withdrawn) there is no way of predicting actual slippage from curve
