...
contract StickmanSplit  {
    ...
    function transferERC20(IERC20 token) public {
        ...
        uint256 _paytoW1 = erc20balance*50/100 ; // K.Poom
        uint256 _paytoW2 = erc20balance*15/100 ; // K.Kayy
        uint256 _paytoW3 = erc20balance*15/100 ; // K.Chris
        uint256 _paytoW4 = erc20balance*15/100 ; // K.Yok
        uint256 _paytoW5 = erc20balance*5/100 ; // VAULT    
