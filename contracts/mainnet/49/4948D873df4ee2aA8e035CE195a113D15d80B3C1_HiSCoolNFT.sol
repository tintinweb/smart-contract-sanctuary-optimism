...
contract HiSCoolNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "HISCOOL";
  string private constant TOKEN_SYMBOL = "HSC";
