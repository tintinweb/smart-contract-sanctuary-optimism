...
contract BeersLabels is Initializable, ERC721Upgradeable, OwnableUpgradeable {
  ...
  function initialize() initializer public {
    __ERC721_init("BeersLabels", "LABEL");
    __Ownable_init();
    metadataBaseUrl = "https://beers.fun/collectibles/labels/";
  ...
  function mintMultiple(address to, uint quantity) public onlyOwner {
