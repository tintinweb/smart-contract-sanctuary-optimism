...
abstract contract Apetimism is Context {
    ...
    uint256 private _apetimismFee = 0;
...
contract OppaBApetimismNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  constructor(address apetimismAddress)
    ERC721A("Oppa BApetimism", "OPPABAPETIMISM")
