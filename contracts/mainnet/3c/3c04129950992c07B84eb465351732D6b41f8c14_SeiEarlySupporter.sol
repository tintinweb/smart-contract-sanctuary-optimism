...
contract SeiEarlySupporter is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // =================== VARIABLES ===========================
    string private hiddenMetadataUri;
    bool public paused = false;
    uint256 public salePrice = 0.0000555 ether;
    uint256 public maxTx = 555;
    uint256 public totalAmount = 555555;
    uint256 private nextTokenId = 1;
    mapping(address => bool) public hasClaimedFreeMint;

    // New state variable to hold the contract owner's address
    address private contractOwner;

    // ================== CONSTRUCTOR ===========================
    constructor() ERC721("Sei Early Supporter", "SEIS") {
    ...
    function mint(uint256 _quantity) external payable nonReentrant {
        ...
        require(_quantity + balanceOf(msg.sender) <= maxTx, "Exceeded max limit");
    ...
    function freeMint() external nonReentrant {
        // require(balanceOf(msg.sender) == 0, "You already claimed a free mint.");
        require(!hasClaimedFreeMint[msg.sender], "You have already claimed your free mint.");
        hasClaimedFreeMint[msg.sender] = true;
        _safeMint(msg.sender, nextTokenId);
        nextTokenId++;
