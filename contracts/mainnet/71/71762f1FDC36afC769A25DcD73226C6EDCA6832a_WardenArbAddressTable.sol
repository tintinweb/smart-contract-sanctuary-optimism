...
import "../arbitrum/interface/IArbAddressTable.sol";

contract WardenArbAddressTable is IArbAddressTable {
    address[] public token;
    mapping(address => uint256) public tokenIds;

    constructor() {
        token.push(0x0000000000000000000000000000000000000000);
    }
     ...
     */
    function decompress(bytes calldata buf, uint256 offset) external pure override returns (address, uint256) {}
     ...
     */
    function compress(address addr) external override returns (bytes memory) {}
}
