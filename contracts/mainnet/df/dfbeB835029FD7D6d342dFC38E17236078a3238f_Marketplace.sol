...
contract Marketplace is IERC721Receiver, ReentrancyGuard, AccessControlEnumerable {
  ...
  bool public clearBidsAfterAcceptingOffer = true;
  ...
  constructor() {
    ...
    _setupRole(DEFAULT_ADMIN_ROLE, 0x6B0897F5f8A3e083b1725CA9f6Ff538619ea4472);
    _setupRole(HIGH_ROLE, 0x6B0897F5f8A3e083b1725CA9f6Ff538619ea4472);
    _setupRole(LOW_ROLE, 0xf60a06DD6d502542d7e5c28bA242944E8f39f246);
    _setupRole(EMERGENCY_ROLE, 0x47aaC6D6699d8Cd5F1AaB6ED3539403D225E1aCd);
  }
  ...
  function listToken(
    ...
    insertOrUpdate(_ca, _tokenId, _price, _listingType, _decreaseTime, _decreasePercentage, _minPrice, _maxPrice);
  }
  ...
  function insertOrUpdate(
    ...
    uint256 index = 999999999999999999;
    for (uint256 i; i < listings[_ca][_tokenId].length; i++) {
      if (listings[_ca][_tokenId][i].price > 0) {
        index = i;
        break;
      }
    }
    if (index == 999999999999999999) {
