...
contract CurveReborn is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // ================== CONSTRUCTOR ===========================
    constructor() ERC721("Curve Reborn OG", "CROG") {}
    ...
    function freeMint() external {
        require(balanceOf(msg.sender) == 0, "You already claim a free mint.");
        require(!hasClaimedFreeMint[msg.sender], "You have already claimed your free mint.");
        hasClaimedFreeMint[msg.sender] = true;
        _safeMint(msg.sender, nextTokenId);
        nextTokenId++;
