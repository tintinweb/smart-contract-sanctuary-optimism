...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://example.com/token/";
...
// File: contracts/OptimismRamppContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptimismRamppContract is RamppERC721A {
    constructor() RamppERC721A("Optimism Rampp", "OPTI"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/8SKScbbOgPx8gy3kuwTL/contract-metadata";
    }
}