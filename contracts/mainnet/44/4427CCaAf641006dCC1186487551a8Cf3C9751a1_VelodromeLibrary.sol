...
contract VelodromeLibrary {
    ...
    function getTradeDiff(uint amountIn, address tokenIn, address tokenOut, bool stable) external returns (uint a, uint b) {
    ...
    function getTradeDiff(uint amountIn, address tokenIn, address pair) external returns (uint a, uint b) {
