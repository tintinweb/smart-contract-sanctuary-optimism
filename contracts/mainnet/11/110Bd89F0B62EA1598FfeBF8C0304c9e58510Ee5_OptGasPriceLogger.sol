...
contract OptGasPriceLogger {
  ...
  function log(bytes calldata input) public returns (bool) {
    ...
    // However we don't have all variables accessible. Only msg.data is of variable length, for rest
    // we use an upper bound of 17 bytes and append it to msg.data
