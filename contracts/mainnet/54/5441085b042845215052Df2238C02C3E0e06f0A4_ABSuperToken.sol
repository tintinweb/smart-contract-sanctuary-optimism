    ...
    ISuperToken
{
    ...
    uint8 constant private _STANDARD_DECIMALS = 6;
 ...
 * @notice Anotherblock Token Wrapper Contract on Optimism
 **/
...
contract ABSuperToken is SuperToken, ERC2771Recipient, AccessControl {
    //     _____ __        __
    ...
    /**
     * @notice
     *  Approves `_spender` address to spend `_amount` of tokens
     *
     *
