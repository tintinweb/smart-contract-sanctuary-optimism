...
// Create by 0xChrisx
// 0xChrisx Version : Test - NEW ERC721A 4.x + Burn + Queryable
...
contract NFT is Ownable, ERC721A, ReentrancyGuard, ERC721AQueryable, ERC721ABurnable {
    ...
    uint256 public collectionSize_ = 1000 ;
    uint256 public maxWlRound =  1000 ;

    uint256 public maxPerPublic = 5;
    uint256 public maxPerWhitelist = 0;
    ...
    constructor() ERC721A("Daiji's Christmas Tree", "DCT") {
...
//------------------ Burn FUNCTION
    function burnNFT(uint256 _number) public {
        burn(_number) ;
        _addressDetail[msg.sender].BurnBalance += 1 ;
    }
//--------------------- END Burn FUNCTION
...
//-------------------- END WhitelistMint
//-------------------- PublicMint
    function mintPublic(uint256 _mintAmount,bytes32[] memory F,bytes32 L) external payable callerIsUser {

        require(mintPhase == 5, "public sale hasn't begun yet");
        require(MerkleProof.verify(F, PBS, L),"Invalid.");
