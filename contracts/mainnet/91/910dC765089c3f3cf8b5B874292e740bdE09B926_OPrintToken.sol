...
contract OPrintToken is Initializable, OwnableUpgradeable, UUPSUpgradeable, ERC20Upgradeable {
    ...
    function initialize() external initializer {
        __ERC20_init("OPrint Token", "OPrint");
        __Ownable_init();
        __UUPSUpgradeable_init();

        minters[msg.sender] = type(uint).max;
    }
