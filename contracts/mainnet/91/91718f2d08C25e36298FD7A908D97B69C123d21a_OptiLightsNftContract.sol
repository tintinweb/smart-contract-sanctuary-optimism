/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-10-12
*/

//*********************************************************************//
//*********************************************************************//
//
//    ____        __  _ __    _       __    __          _   ______________
//   / __ \____  / /_(_) /   (_)___ _/ /_  / /______   / | / / ____/_  __/
//  / / / / __ \/ __/ / /   / / __ `/ __ \/ __/ ___/  /  |/ / /_    / /   
// / /_/ / /_/ / /_/ / /___/ / /_/ / / / / /_(__  )  / /|  / __/   / /    
// \____/ .___/\__/_/_____/_/\__, /_/ /_/\__/____/  /_/ |_/_/     /_/     
//     /_/                  /____/                                        
//
//*********************************************************************//
//*********************************************************************//
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibcdofluwwb7lv66obajc6yepsclhxpnikelnjlqtxszdgf5elute/";
...
// File: contracts/OptiLightsNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptiLightsNftContract is RamppERC721A {
    constructor() RamppERC721A("OptiLights NFT", "OPTLIGHT"){}
}
