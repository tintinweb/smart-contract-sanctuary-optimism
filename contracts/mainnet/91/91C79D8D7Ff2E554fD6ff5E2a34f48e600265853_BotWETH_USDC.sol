...
contract BotWETH_USDC is IERC721Receiver {
    ...
    function _decreaseLiquidity(
        ...
        (uint256 amountFee0, uint256 amountFee1) = _collectAllFees(tokenId);
        TransferHelper.safeTransfer(WETH, msg.sender, amountFee0);
        TransferHelper.safeTransfer(USDC, msg.sender, amountFee1);
    }
