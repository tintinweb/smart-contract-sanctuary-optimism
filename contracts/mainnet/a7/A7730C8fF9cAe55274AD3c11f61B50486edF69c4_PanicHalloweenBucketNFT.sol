...
contract PanicHalloweenBucketNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "Panic Halloween Bucket";
  string private constant TOKEN_SYMBOL = "PANICHBUCKET";
