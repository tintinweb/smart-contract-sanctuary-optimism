...
contract Pangea is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('Pangea', 'PANGEA') {}
    ...
    function mintPangea(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of Pangea");
