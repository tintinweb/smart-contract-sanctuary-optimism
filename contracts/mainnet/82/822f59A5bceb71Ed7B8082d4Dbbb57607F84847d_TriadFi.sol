/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-02-10
*/

/* FaaS - Triad Finance * https://TriadFi.xyz */
...
contract TriadFi is ERC20, Ownable {
  constructor() public ERC20("TriadFi", "TRI") { // Symbol and Name

    _mint(msg.sender, 420000000000000000000000000); // Creates initial supply of 420 Million tokens.
  }
  ...
  function setTransferFee(uint256 fee) public onlyOwner {
    require(fee <= 4500, "Fee cannot be greater than 8.88%"); // Throws an error upon transfer if above 8.88%
    if (fee == 0) {
      activeFee = false;
    } else {
      activeFee = true;
