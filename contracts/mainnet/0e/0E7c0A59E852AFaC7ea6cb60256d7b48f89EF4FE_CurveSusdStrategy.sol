...
contract BasicStrategy is VaultConnected, Governable {
    ...
    address payable public univ3Router2 = payable(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
    ...
    function harvestAndReinvest() public virtual onlyGovernance {
        ...
        for (uint256 i = 0; i < rewards.length; i++) {
            ...
            console.log("balanceOfCurrentReward", balanceOfCurrentReward);
            ...
            uint256 amountOut = ISwapRouter03(univ3Router2).exactInput(
                IV3SwapRouter.ExactInputParams({
                    path: abi.encodePacked(rewards[i], poolFee, ISwapRouter03(univ3Router2).WETH9(), poolFee, wantToken),
    ...
    function setDepositFee(uint256 _feeRate) public onlyGovernance {
        require(_feeRate < 700000000, "Max fee reached");
