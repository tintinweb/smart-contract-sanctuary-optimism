...
contract SwitchCelerReceiverOptimism is SwitchOptimism {
    ...
    ) SwitchOptimism(_switchViewAddress, _switchEventAddress, _paraswapProxy, _augustusSwapper)
        public
    {
...
import "./SwitchRootOptimism.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

contract SwitchOptimism is SwitchRootOptimism {
...
abstract contract SwitchRootOptimism is ISwitchView {
    ...
    IWETH constant internal weth = IWETH(0x4200000000000000000000000000000000000006);

    IUniswapFactory[DEXES_COUNT] public factories = [
        IUniswapFactory(0x8BCeDD62DD46F1A76F8A1633d4f5B76e0CDa521E) // zipswap,
    ];
