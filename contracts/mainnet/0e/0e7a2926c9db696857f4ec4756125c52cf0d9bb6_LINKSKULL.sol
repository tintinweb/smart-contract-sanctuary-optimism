/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-12-22
*/
...
contract LINKSKULL is ERC721, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
        uint256 MAX_SUPPLY = 7;

    constructor() ERC721("LINK SKULL", "SKULL") {}

    function safeMint(address to, string memory uri) public {
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "I'm sorry fr no cap");
