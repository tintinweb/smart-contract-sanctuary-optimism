...
// File: contracts/BIFI/strategies/BIFI/StrategyBifiMaxiV5Solidly.sol


pragma solidity ^0.8.0;
contract StrategyBifiMaxiV5Solidly is StratFeeManager, GasFeeThrottler {
    ...
    constructor(
        ...
        output = _outputToWantRoute[0].from;
