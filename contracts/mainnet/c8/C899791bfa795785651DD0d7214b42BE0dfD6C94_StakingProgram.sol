...
contract StakingProgram is Ownable, SafeMath {
    ...
    function unstake(uint256 _tokens_amount) external {
        ...
        // if user unstaking all of his stake then also add his rewards and clean the remainder
        ...
        require(erc20tokenInstance.transfer(msg.sender, _unstaking_amount), "Error in unstaking tokens.");
