...
contract Interaction is Initializable, UUPSUpgradeable, OwnableUpgradeable, WardedLivingUpgradeable, IInteraction {
    ...
    function unstake(uint256 fundId, uint256 amount) external override live {
        ...
        feeder.requestWithdrawal(fundId, msg.sender, amountOut);

        emit UnStake(fundId, msg.sender, amount, funds[fundId].itoken.balanceOf(msg.sender));
    }

    function drip(uint256 fundId) external override live auth {
        require(fundExist(fundId), "Interaction/fund-not-exists");
...
interface IFeeder {
    ...
    */
    ...
    function drip(uint256 fundId, address trader) external;
...
interface IInteraction {
    ...
    function drip(uint256 fundId) external;
    function withdrawMultiple(uint256 fundId, address[] calldata users) external;
