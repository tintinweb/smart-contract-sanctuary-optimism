...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x108A6dDD5f1030352c5e7A69D53df82C40c4418E];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 1024 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRHMSYUkNAPQoLuytXbL8d1Bc4dGypj4MmUc2H4KTLyPv/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1024");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1024");
...
// File: contracts/OptiDudesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptiDudesContract is RamppERC721A {
    constructor() RamppERC721A("OptiDudes", "OPTIDUDES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Kx47M09UetIXrqfothNb/contract-metadata";
    }
}
