...
library Constants {
    /* Chain */
    uint256 private constant CHAIN_ID = 10; // Optimism
    ...
    address private constant CRV3 =
        address(0x1337BedC9D22ecbe766dF105c9623922A27963EC); // Anywhere the term CRV3 is refernenced, consider that as "peg", really
    ...
    uint256 private constant CURRENT_EPOCH_START = 1669640400;
    ...
    ERC20Burnable
{
    constructor()
        public
        ERC20Detailed("Optimium Dollar", "OD", 18)
        Permittable()
    {}
