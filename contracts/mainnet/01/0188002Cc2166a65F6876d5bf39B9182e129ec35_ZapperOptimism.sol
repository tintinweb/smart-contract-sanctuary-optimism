...
contract ZapperOptimism is MatrixSwapHelper, Ownable {
    ...
    constructor() MatrixSwapHelper(ZIPSWAP_ROUTER) {
        ...
        // Factory to Router
        // ZipSwap Optimism
        factoryToRouter[0x8BCeDD62DD46F1A76F8A1633d4f5B76e0CDa521E] = 0xE6Df0BB08e5A97b40B21950a0A51b94c4DbA0Ff6;
    ...
    function _getRouter(address _lpToken) internal view returns (address) {
