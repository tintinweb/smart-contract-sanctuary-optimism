...
import "../optimism/IL2StandardERC777.sol";
import "../recovery/recovery.sol";

contract L2GoldToken is IL2StandardERC777, ERC777, recovery { 
    ...
    constructor(address newOwner, address _l2Bridge, address _l1Token) ERC777(_name,_symbol,nilOps) {
        transferOwnership(newOwner);
        l2Bridge = _l2Bridge;
        l1Token = _l1Token;
    }

    function mint(address to, uint256 amount) external onlyL2Bridge {
    ...
    function burn(uint256 , bytes memory ) public override {
        revert("public burn not implemented on L2");
    }
    ...
    function operatorBurn(
        ...
        revert("public operator burn not implemented on L2");
    }

        // slither-disable-next-line external-function
    function supportsInterface(bytes4 _interfaceId) public pure returns (bool) {
        bytes4 firstSupportedInterface = bytes4(keccak256("supportsInterface(bytes4)")); // ERC165
        bytes4 secondSupportedInterface = IL2StandardERC777.l1Token.selector ^
            IL2StandardERC777.mint.selector ^
            IL2StandardERC777.burn.selector;
...
interface IL2StandardERC777 is IERC165 {
