...
contract ControllerAaveStrat is ControllerStratAbs {
    ...
    function _claimRewards() internal override {
        ...
        address _reward = rewardTokens.length > 0 ? rewardTokens[0] : address(0);
...
contract PoolMock {
    ...
    function repayWithATokens(address _asset, uint _amount, uint _rateMode) public {
        repay(_asset, _amount, _rateMode, address(0));
    }
