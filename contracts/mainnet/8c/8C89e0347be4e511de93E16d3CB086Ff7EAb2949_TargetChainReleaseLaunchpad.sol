...
// File: contracts/bridge/interfaces/ILayerZeroReceiver.sol
...
// File: contracts/bridge/lzApp/LzApp.sol
...
// File: contracts/bridge/lzApp/NonblockingLzApp.sol
...
// File: contracts/presale/TargetChainReleaseLaunchpad.sol


pragma solidity ^0.8.0;


contract TargetChainReleaseLaunchpad is NonblockingLzApp {
    using SafeERC20 for IERC20;

    IERC20 public token;

    constructor(IERC20 _token, address _lzEndpoint) NonblockingLzApp(_lzEndpoint) {
        token = _token;
    }
