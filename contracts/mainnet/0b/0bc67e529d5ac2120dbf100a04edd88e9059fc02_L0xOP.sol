...
contract L0xOP is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // ================== CONSTRUCTOR ===========================
    constructor() ERC721("LayerZERO x OPTIMISM", "L0P") {}
    ...
    function mint(uint256 _quantity) external payable {
        ...
        require(
            lastMintTimestamp[msg.sender] + 1 days <= block.timestamp,
            "You can only mint 10 per day"
        );
