...
// File src/strategies/optimism/velodrome/strategy-velo-usdc-ageur-vlp.sol
// License-Identifier: MIT
pragma solidity ^0.6.7;
...
contract StrategyVeloUsdcAgeurVlp is StrategyVeloBase {
        ...
        )
    {
        ...
        // token1 route
        nativeToTokenRoutes[ageur].push(RouteParams(native, usdc, false));
        nativeToTokenRoutes[ageur].push(RouteParams(usdc, ageur, false));
    }
