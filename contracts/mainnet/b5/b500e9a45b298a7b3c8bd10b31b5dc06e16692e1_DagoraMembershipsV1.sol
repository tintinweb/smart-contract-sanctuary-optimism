    ...
    ERC721AUpgradeable
{
        ...
        payable
    {
        ...
        (bool sent, ) = dagoraTreasury.call{value: msg.value}("");
        require(sent, "dAgoraMemberships: Failed to send Ether");
    ...
    /// @notice Function to set the price of a Ecclesia tier membership renewal.
    /// @dev Only owner can call this function.
    function setEcclesiaRenewPrice(uint256 _price) external onlyOwner {
        ecclesiaRenewPrice = _price;
    }
