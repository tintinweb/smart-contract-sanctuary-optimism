...
contract Perp_Booster_2
{
    ...
    constructor() {
        ...
        //clearningHouse = IClearingHouse(0xaD2663386fe55e920c81D55Fc342fC50F91D86Ca);
    }

    function perp_deposit4(address token, uint256 amount) external  {
        //
        vault.depositFor(address(this), token, amount); 
    }
}