...
contract VelodromeOptimismUsdcDai is DefiiWithCustomEnter {
    ...
    IERC20 constant lpToken =
        IERC20(0x4F7ebc19844259386DBdDB7b2eB759eeFc6F8353);
    ...
    IGauge constant gauge = IGauge(0xc4fF55A961bC04b880e60219CCBBDD139c6451A4);
        ...
        returns (bytes memory)
    {
        ...
        (uint256 daiMinAmount, ) = router.getAmountOut(usdcToSwap, USDC, DAI);
        return abi.encode(usdcToSwap, (daiMinAmount * slippage) / 1000);
    }
    ...
    function _enter() internal override {
        ...
        _enter(usdcBalance, daiBalance);
    }

    function _enter(uint256 usdcBalance, uint256 daiBalance) internal {
