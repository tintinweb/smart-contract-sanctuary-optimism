...
contract MultichainRouter is IMultichainPortal, Pausable, Ownable {
    ...
    function swapERC20AndCall(
        ...
        require(
            IERC20(tokenIn).transferFrom(msg.sender, address(Portal), amountIn),
            "funds transfer failed"
        );
        Portal.swapERC20AndCall(tokenIn, amountIn, msg.sender, swapRouter, swapArguments, calls);
    }
    ...
    function swapNativeAndCall(
        ...
        Portal.swapNativeAndCall{value: msg.value}(swapRouter, swapArguments, calls);
    }
