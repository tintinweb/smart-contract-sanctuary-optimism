...
contract DeltaNeutralPerp is StrategyStorage {
    ...
    */
    function depositUSDC(uint256 amount) public {
        ...
        require(getTotalUSDCValue() + amount <= maxPoolSizeLimit, "DNP: Exceeding total pool limit");
    ...
    */
    ...
    function setMaxPoolSizeLimit(uint256 _newLimit) public onlyOwner {
        // require(_newLimit > 0, "dcStrategyStorage: zero amount"); // 200 Gas
        maxPoolSizeLimit = _newLimit;
    }


    function allowDeposit(address user) public onlyOwner {
        _allowList[user] = true;
        emit DepositAllowed(user);
    }


    function denyDeposit(address user) public onlyOwner {
    ...
    */
    function adjustPosition(bool operationType, bool positionType, uint256 amount) public onlyTrigger() {
        ...
        if (operationType) { // openPosition
            ...
            if(positionType) {
                ...
                /// long/sell wToken
                if (FullMath.mulDiv(IERC20(_wToken).balanceOf(address(this)),
    ...
    function chargePf() public onlyTrigger() {
        ...
        require(blockTime - _lastPfChargeTime > _DAILY_SECONDS, "DNP: pf already gathered");
    ...
    * @return fundingRate_10_6
    ...
    function _closePositionsForWithdrawal(uint256 reserve, uint256 toWithdraw) private {
        ...
        uint256 wTokenAmount = FullMath.mulDiv(toClose, 1e18, _nativeStrategyTokenPrice(0));
