...
// File src/strategies/optimism/velodrome/strategy-velo-usdc-frax-slp.sol
// License-Identifier: MIT
pragma solidity ^0.6.7;
...
contract StrategyVeloUsdcFraxSlp is StrategyVeloBase {
        ...
        )
    {
        ...
        // token1 route
        nativeToTokenRoutes[frax].push(RouteParams(native, usdc, false));
        nativeToTokenRoutes[frax].push(RouteParams(usdc, frax, true));
    }
