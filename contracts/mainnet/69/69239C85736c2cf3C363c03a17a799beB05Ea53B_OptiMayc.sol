...
contract OptiMayc is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint256 public constant NFT_PRICE = 10000000000000000; // 0.01 ETH
    uint256 public MAX_SUPPLY = 14041;
    ...
    constructor() ERC721('Optimistic Mutant Apes', 'OPTIMAYC.COM') {}
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of Punks");
