...
contract QuixoticLaunchpadERC721 is ERC721("Oliens", "OLIENS"), ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens + addressToNumberMinted[_msgSender()] <= 2222, "Exceeded max token purchase");
