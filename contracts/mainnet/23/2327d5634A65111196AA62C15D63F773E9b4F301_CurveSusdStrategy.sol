...
contract CurveSusdStrategy is BasicStrategy {
    ...
    /// @notice sets max slippage allowed
    function setMaxSlippageAllowed(uint256 __slippageAllowed) public onlyGovernance {
        require(__slippageAllowed < 500000000, "Max slippage reached");
        _slippageAllowed = __slippageAllowed;
    }

    /// @dev gets max slippage allowed
    function getMaxSlippageAllowed() public view returns (uint256) {
        return _slippageAllowed;
    }
}
