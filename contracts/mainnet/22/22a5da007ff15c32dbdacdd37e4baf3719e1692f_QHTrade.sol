...
contract QHTrade is ITrade, Initializable {
    ...
    function initialize(
        ...
        if (chainId == 56) {
            accessControl = ITradeAccess(0x7E24bf2cCE7A0a5024f5F31a4575A6FAFA0d613f);
        } else if (chainId == 10) {
            accessControl = ITradeAccess(0x716B5D96A080EfeB6C9078ffdF0aD241060c4e36);
        } else if (chainId == 42161) {
            accessControl = ITradeAccess(0x007d316DdB7878b7d2107A6Ca8Ee53A2d60a70dF);
        } else {
            revert("Unsupported chain. Deploy access control first");
        }
    }
