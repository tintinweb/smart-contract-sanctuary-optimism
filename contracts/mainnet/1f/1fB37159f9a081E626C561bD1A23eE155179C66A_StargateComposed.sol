...
import {UniRouterV2} from "../interfaces/UniV2.sol";
import { IV3SwapRouter } from "../interfaces/UniV3.sol";
...
contract StargateComposed is IStargateReceiver, WardedLiving {
    ...
    function toBridgeAsset(address srcToken, uint256 amountIn) public returns (uint256) {
        ...
        return IV3SwapRouter(ammRouter).exactInputSingle(params);
    }
    ...
    function bridge(
        ...
        uint256 bridgeTokenAmount = amountIn;
        if (srcToken != bridgeToken) {
            bridgeTokenAmount = toBridgeAsset(srcToken, amountIn);
        }
        ...
        IStargateRouter(stargateRouter).swap{value : msg.value}(
            ...
            0, // minimum
            IStargateRouter.lzTxObj(500000, 0, "0x"), // 200,000 for the sgReceive()
