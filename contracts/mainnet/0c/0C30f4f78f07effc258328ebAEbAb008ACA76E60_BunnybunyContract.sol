...
//*********************************************************************//
//
//   ____ _ _ _ _ _ _ __ __ ___ _ _ _ _ __ __
//  | _ \ | | | | | \ | | | \ | | \ \ / / | _ \ | | | | | \ | | \ \ / /
//  | |_) | | | | | | \| | | \| | \ \_/ / | |_) | | | | | | \| | \ \_/ /
//  | _ < | | | | | . ` | | . ` | \ / | _ < | | | | | . ` | \ /  
//  | |_) | | |__| | | |\ | | |\ | | | | |_) | | |__| | | |\ | | |   
//  |____/ \____/ |_| \_| |_| \_| |_| |____/ \____/ |_| \_| |_|   
//                                                                                 
//                                                                                 
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xBA81Da40a7eeE8616AC6f09B9A08Bf1F29F06a9a];
  address public erc20Payable = 0xBA81Da40a7eeE8616AC6f09B9A08Bf1F29F06a9a;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmeLj46CXvTLqPmCAvno9rwUzNRLWAS5KDRCacyYyzuN3U/";
...
// File: contracts/BunnybunyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BunnybunyContract is RamppERC721A {
    constructor() RamppERC721A("BUNNY BUNY", "BUNNYNFT"){}
}
