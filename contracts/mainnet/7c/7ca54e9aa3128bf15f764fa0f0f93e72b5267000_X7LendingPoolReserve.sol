...
For ease of integration, contracts may choose to simply send native tokens to this contract and they will receive X7D.
...
The full X7D ecosystem will evolve over time. While all native token funds deposited to this contract will remain locked in X7 ecosystem smart contracts not all native tokens will remain in THIS contract.
...
You should NOT mint X7D from this contract unless you are willing to wait an indeterminate amount of time to withdraw your native tokens on a first come/first serve basis.
