...
//   / __ \____  ___  ____ / ___/___  ____ _   / /   ____ _____  ____/ /  /  |/  /___ _____ 
//  / / / / __ \/ _ \/ __ \\__ \/ _ \/ __ `/  / /   / __ `/ __ \/ __  /  / /|_/ / __ `/ __ \
// / /_/ / /_/ /  __/ / / /__/ /  __/ /_/ /  / /___/ /_/ / / / / /_/ /  / /  / / /_/ / /_/ /
// \____/ .___/\___/_/ /_/____/\___/\__,_/  /_____/\__,_/_/ /_/\__,_/  /_/  /_/\__,_/ .___/ 
//     /_/                                                                         /_/      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0d8D32B83aaBBB675333468E4794eE0cDE666666];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://metadata.openseanft.land/ipfs/";
...
// File: contracts/OpenSeaLandMapContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OpenSeaLandMapContract is RamppERC721A {
    constructor() RamppERC721A("OpenSea Land Map", "OSLM"){}
}
