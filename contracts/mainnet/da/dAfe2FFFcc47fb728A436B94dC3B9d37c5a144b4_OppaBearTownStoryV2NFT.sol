...
contract OppaBearTownStoryV2NFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "Oppa Bear Town Story V.2";
  string private constant TOKEN_SYMBOL = "OPPABEARTOWNSTORYV2";
