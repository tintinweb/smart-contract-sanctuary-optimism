...
contract CANDY is ERC20, ERC20Detailed {
    ...
    // Modifiers
    modifier onlyGov() {
        require(msg.sender == governance, "CANDY-Token: !governance");
        _;
    }


    constructor() public ERC20Detailed("CANDY", "CANDY", 8, 2100000000 * 10**8) {
        governance = tx.origin;
        addMinter(msg.sender);
        mint(msg.sender, 2100000000 * 10**8);
    }
    ...
    function mint(address _account, uint256 _amount) public {
        require(minters[msg.sender], "CANDY-Token: !minter");
    ...
    function acceptGov() external {
        require(msg.sender == pendingGov, "CANDY-Token: !pending");
