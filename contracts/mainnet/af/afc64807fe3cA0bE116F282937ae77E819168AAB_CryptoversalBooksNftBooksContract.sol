...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x6d89180D5719D88Ff224bAbA67480398e29561d4,0xdd5d6Fa8B5Eb8828CBadd7946A77FEaC2A8379B8];
  uint256[] public payableFees = [51,49];
...
// File: contracts/CryptoversalBooksNftBooksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract CryptoversalBooksNftBooksContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Cryptoversal Books NFTBooks";
    string public symbol = "CBNFTBKS";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BeV0H3AknXfbcx6udvg7/contract-metadata";
  }
