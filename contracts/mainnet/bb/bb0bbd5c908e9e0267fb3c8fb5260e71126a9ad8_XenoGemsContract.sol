...
//
//            _  __                    ______                   
//   | |/ /__  ____  ____     / ____/__  ____ ___  _____
//   |   / _ \/ __ \/ __ \   / / __/ _ \/ __ `__ \/ ___/
//  /   /  __/ / / / /_/ /  / /_/ /  __/ / / / / (__  ) 
// /_/|_\___/_/ /_/\____/   \____/\___/_/ /_/ /_/____/  
//                                                      
//     
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8b687b7a7086eE39F5459a8611EA51d3175Dc1F5];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 254 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNSUL8mQySuAjCRsvFPqXS17nNChkprpAZTq8nmLvvgPe/";
...
// File: contracts/XenoGemsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract XenoGemsContract is RamppERC721A {
    constructor() RamppERC721A("Xeno Gems", "XENO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gTXaRRSpBpWSIT8Md4Q5/contract-metadata";
    }
}
