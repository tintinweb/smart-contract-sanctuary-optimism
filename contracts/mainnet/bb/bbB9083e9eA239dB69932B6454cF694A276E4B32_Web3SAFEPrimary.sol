...
contract Web3SAFEPrimary is Web3SAFE {
    ...
    Compliance immutable public compliance;
    ...
    function initialize(
        ...
        compliance.addWhitelistOperator(
            token,
            address(this)
        );
    ...
    function configure(
        ...
        onRun(_safeId)
    {
        SafeConfig memory c = config[_safeId];
        require(msg.sender == beneficiary(_safeId) || msg.sender == c.control);
        _configure(
            _safeId,
            _control,
            _recipient,
...
abstract contract Web3SAFE is Initializable {
    ...
    bytes32 public constant PERMIT_NEW_ALLOCATION_TYPEHASH = 0x92e9c7780c37c6c93752ef6c68ad3040c058ba77173b0ed956a3a1618f819712;
    ...
    {
        require(
            msg.sender == config[_safeId].control || msg.sender == beneficiary(_safeId) || isAdmin[_safeId][msg.sender], "!(beneficiary||control||admin)"
        );
        config[_safeId] =
