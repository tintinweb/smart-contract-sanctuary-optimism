...
contract goblintownNFT is ERC721A, Ownable, ReentrancyGuard {  
    ...
    function _baseURI() internal view virtual override returns (string memory) {
 	...
 	function makingobblin() external payable nonReentrant {
  	    uint256 totalgobnlinsss = totalSupply();
        require(msg.value >= 0.01 ether, "msg.value <= 0.01 ether");
        require(byebye, "Not allowed to mint");
        require(totalgobnlinsss + goblinbyebye <= goblins, "totalgobnlinsss + goblinbyebye >= goblins");
        require(msg.sender == tx.origin, "msg.sender != tx.origin");
    	require(howmanygobblins[msg.sender] < 10 * goblinbyebye, "howmanygobblins[msg.sender] > goblinbyebye");
