...
contract NukeVault is ERC20, IERC4626, Minion, Pausable {
    ...
    constructor(
        ...
        ERC20(
            string(abi.encodePacked("Nuke Vault OPCRVSUSD Token", _name)),
            string(abi.encodePacked("nukeOPCRVSUSD", _symbol))
        )
    {
        ...
        returns (uint256 shares)
    {
        ...
        // uint256 depositAmount = IStrategy(strategy).calcUnderlyingFinalDeposit(assets.sub(depositFee));
    ...
    function maxWithdraw(address owner)
        ...
        returns (uint256 maxAssets)
    {
        return convertToAssets(balanceOf(owner)); // TODO: get back and test this thorougly
    }
