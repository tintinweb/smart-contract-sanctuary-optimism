...
// File: contracts/interfaces/ISlippageIssuanceModule.sol
...
// File: contracts/arbitrage/Withdrawable.sol
...
// File: contracts/flash-issuance/PerpFlashIssuanceV2.sol
...
contract PerpFlashIssuanceV2  is Withdrawable {
        ...
        isInitializedSet(_setToken)
    {
        ...
        TransferHelper.safeTransferFrom(address(usdc), address(this), msg.sender, usdcBalance);
    }
