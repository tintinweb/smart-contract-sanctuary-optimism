/**
 *Submitted for verification at optimistic.etherscan.io on 2022-06-16
*/
...
contract TokenMasks is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string baseURI = "";
    string public baseExtension = ".json";
    uint256 private preCost = 100 ether;
    uint256 private publicCost = 100 ether;
    ...
    mapping(address => uint256) private Lists;
    ...
    function publicMint() public payable {
        ...
        if(Lists[msg.sender] == 0){
            whiteLists[msg.sender] = 5;
            Lists[msg.sender] = 5;
        }

        if(whiteLists[msg.sender] != 0 && Lists[msg.sender] == 5){
            _safeMint(msg.sender, supply + 1);
            whiteLists[msg.sender]--;
        }

        require(whiteLists[msg.sender] >= mintAmount, "mint count max");
    ...
    function preMint() public payable {
        ...
        require(
            whiteLists[msg.sender] >= mintAmount,
            "CL: Witch max per address in Witchlist."
        );
        _safeMint(msg.sender, supply + 1);
        whiteLists[msg.sender]--;
    }
    ...
    function setMaxSupply(uint256 _num) public onlyOwner {
        maxSupply = _num;
    }
    ...
    function withdraw() public virtual {
        // DAO account 0x948CDA37d4237BDcA30eE2E9AAB8De6b947AE713
        (bool dao, ) = payable(0x948CDA37d4237BDcA30eE2E9AAB8De6b947AE713).call{
            value: (address(this).balance * 30) / 100
        }("");
        require(dao);

        // TEAM account 0x948CDA37d4237BDcA30eE2E9AAB8De6b947AE713
        (bool team, ) = payable(0x948CDA37d4237BDcA30eE2E9AAB8De6b947AE713)
    ...
    function ListsCountOfOwner(address owner)
        public
        view
        returns (uint256)
    {
