...
contract AaveOPrintOption is OPrintOption {
    ...
    function deposit(uint amount) external override virtual {
        _deposit(amount, msg.sender);
        userTotal += amount;

        pool.supply(encoder.encodeSupplyParams(address(stake), amount, 0));
    }

    function withdraw(uint amount) external override virtual {
