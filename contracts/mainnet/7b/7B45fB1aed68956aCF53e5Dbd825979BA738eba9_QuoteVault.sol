...
import { CommonVaultStorageV2 } from "./storage/CommonVaultStorage.sol";
import { IRouter } from "./interface/IRouter.sol";
import { IRouterStruct } from "./interface/IRouterStruct.sol";

abstract contract CommonVault is ICommonVault, OwnerPausable, ReentrancyGuardUpgradeable, CommonVaultStorageV2 {
    using AddressUpgradeable for address;
...
contract QuoteVault is CommonVault {
    ...
    // TODO: deleverage when deposit/withdraw/swap, currently, we only rely on our keeper bot to do deleverage
