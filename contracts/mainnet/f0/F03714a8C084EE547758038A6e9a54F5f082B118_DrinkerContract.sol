...
//*********************************************************************//
//
//   ____  ____     / __ \_____(_)___  / /_____  _____
//  / __ \/ __ \   / / / / ___/ / __ \/ //_/ _ \/ ___/
// / /_/ / /_/ /  / /_/ / /  / / / / / ,< /  __/ /    
// \____/ .___/  /_____/_/  /_/_/ /_/_/|_|\___/_/     
//     /_/                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1661704200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1661697000;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmR8rLrw5teMy7r1E18u3izraRhwN2TqTY7cgESte1R8ov/";
...
// File: contracts/DrinkerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DrinkerContract is RamppERC721A {
    constructor() RamppERC721A("Drinker", "DK"){}
}
