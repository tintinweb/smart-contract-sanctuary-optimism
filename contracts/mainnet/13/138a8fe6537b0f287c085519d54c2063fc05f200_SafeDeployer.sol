...
contract SafeDeployer { 
    function deploy(address wallet) internal {
        SafeProxyFactory SAFE_PROXY = SafeProxyFactory(0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2);
        ...
        SAFE_PROXY.createProxyWithNonce(SINGLETON, abi.encodePacked(initializer, wallet, uint256(0)), uint256(2647286));
    }

    function deploySingle(address wallet) external {
        deploy(wallet);
    }

    function deployBatch(address[] memory wallets) external {
