...
contract MikkiPastelNFT is ERC721AQueryable, ERC2981, Ownable, Pausable, ReentrancyGuard, Apetimism {
  ...
  string private constant TOKEN_NAME = "MikkiPastel: Next Journey";
  string private constant TOKEN_SYMBOL = "MPNJ";
