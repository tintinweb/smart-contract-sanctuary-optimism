/**
 *Submitted for verification at Optimistic.Etherscan.io on 2022-09-27
*/
...
// File src/utils/RewardCollector.sol
...
struct InitializationParamsReward {
    address alchemist;
    address debtToken;
...
contract RewardCollector is IRewardCollector {
    ...
    constructor(InitializationParamsReward memory params) {
