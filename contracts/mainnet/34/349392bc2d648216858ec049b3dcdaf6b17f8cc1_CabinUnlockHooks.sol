...
interface IPublicLock {
     ...
     */
    function setLockMetadata(string calldata _lockName, string calldata _lockSymbol, string calldata _baseTokenURI)
        external;
     ...
     */
    function extend(uint256 _value, uint256 _tokenId, address _referrer, bytes calldata _data) external payable;
     ...
     */
    function purchasePriceFor(address _recipient, address _referrer, bytes calldata _data)
        external
        view
        returns (uint256);
