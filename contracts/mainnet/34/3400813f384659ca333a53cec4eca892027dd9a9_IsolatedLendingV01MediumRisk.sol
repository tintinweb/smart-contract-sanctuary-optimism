...
contract IsolatedLendingV01MediumRisk is ERC4626{
    ...
    constructor(address _feeTo, address _sequencerUptimeFeed){
        owner = msg.sender;
        feeTo = _feeTo;
        masterContract = this;
    ...
    function liquidate(address _user, uint256 _amount) external returns (bool) {
        accrue();
    ...
    function updateExchangeRate() public returns (bool){
