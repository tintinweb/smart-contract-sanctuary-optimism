...
//*********************************************************************//
//
//     __   ___  _____ __        __       ____  ______  ____           __
//    / /  |__ \/ ___// /_____ _/ /____  / __ \/ __/  |/  (_)___  ____/ /
//   / /   __/ /\__ \/ __/ __ `/ __/ _ \/ / / / /_/ /|_/ / / __ \/ __  / 
//  / /___/ __/___/ / /_/ /_/ / /_/  __/ /_/ / __/ /  / / / / / / /_/ /  
// /_____/____/____/\__/\__,_/\__/\___/\____/_/ /_/  /_/_/_/ /_/\__,_/   
//                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1661817600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1661796000;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieeqqe42bk5jhyvoksixjlvbv7gakl654hob4k2ut33pyz3xohple/";
...
// File: contracts/L2StateOfMindContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract L2StateOfMindContract is RamppERC721A {
    constructor() RamppERC721A("L2StateOfMind", "L222"){}
}